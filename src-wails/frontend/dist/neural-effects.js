...
class NeuralCanvas {
    constructor(canvasId) {
        ...
        if (isWeb && navigator.gpu) {
            console.log('[WebGPU Next-Gen] Moteur graphique 2028 initialisé. Hardware accélération détectée.');
            // Initialize WebGPU context (Mocked for now as foundation)
            this.gpuEnabled = true;
        } else {
            console.log('[Legacy/Android] Fallback sur Canvas 2D sécurisé.');
