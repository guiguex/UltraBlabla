...
- Name: voice-interaction.spec.ts >> UltraBlabla Voice Interaction Simulation >> should load the page and allow microphone access
- Location: tests/voice-interaction.spec.ts:5:3
...
║ -  current: mcr.microsoft.com/playwright:v1.41.0-jammy ║
