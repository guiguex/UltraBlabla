  ...
  "node_modules/@capacitor/core/dist/index.js"() {
    ...
    getPlatformId = (win) => {
      ...
      if (win === null || win === void 0 ? void 0 : win.androidBridge) {
        return "android";
      } else if ((_b2 = (_a = win === null || win === void 0 ? void 0 : win.webkit) === null || _a === void 0 ? void 0 : _a.messageHandlers) === null || _b2 === void 0 ? void 0 : _b2.bridge) {
        return "ios";
      } else {
        return "web";
      }
...
async function fs(t = {}) {
  ...
  e.mountExternalData = (s, l) => {
    s.startsWith("./") && (s = s.substring(2)), (e.Yc || (e.Yc = /* @__PURE__ */ new Map())).set(s, l);
  }, e.unmountExternalData = () => {
    delete e.Yc, delete e.Zd, delete e.Yd, delete e.$d;
  }, globalThis.SharedArrayBuffer ?? new WebAssembly.Memory({ initial: 0, maximum: 0, shared: true }).buffer.constructor;
  let i = (s) => async (...l) => {
    try {
      if (e.Xc) throw Error("Session already started");
      let h = e.Xc = { Kd: l[0], errors: [] }, f = await s(...l);
      if (e.Xc !== h) throw Error("Session mismatch");
      e.dd?.flush();
      let $ = h.errors;
      if (0 < $.length) {
...
`));
  ...
  e.jsepInit = (s, l) => {
    if (s === "webgpu") {
      ...
      let h = e.dd;
      e.jsepRegisterBuffer = (f, $, C, P) => h.registerBuffer(f, $, C, P), e.jsepGetBuffer = (f) => h.getBuffer(f), e.jsepCreateDownloader = (f, $, C) => h.createDownloader(f, $, C), e.jsepOnCreateSession = (f) => {
        h.onCreateSession(f);
      }, e.jsepOnReleaseSession = (f) => {
        h.onReleaseSession(f);
      }, e.jsepOnRunStart = (f) => h.onRunStart(f), e.Id = (f, $) => {
        h.upload(f, $);
      };
    } else if (s === "webnn") {
      let h = l[0];
  ...
  if (r || n) {
    ...
    n && (d = (s) => {
      ...
      if (D(s)) return new Promise((h, f) => {
        var $ = new XMLHttpRequest();
        $.open("GET", s, true), $.responseType = "arraybuffer", $.onload = () => {
          $.status == 200 || $.status == 0 && $.response ? h($.response) : f($.status);
        }, $.onerror = f, $.send(null);
      });
  ...
  var g, y, b, _, S, x, v = console.log.bind(console), T = console.error.bind(console), I = v, E = T, A = false, D = (s) => s.startsWith("file://");
  function w() {
  ...
  if (o) {
    let s = function(l) {
      try {
        ...
        if (f === "load") {
          let $ = [];
          self.onmessage = (C) => $.push(C), x = () => {
            postMessage({ Sc: "loaded" });
            for (let C of $) s(C);
            self.onmessage = s;
          };
          for (let C of h.xd) e[C] && !e[C].proxy || (e[C] = (...P) => {
            postMessage({ Sc: "callHandler", vd: C, args: P });
          }, C == "print" && (I = e[C]), C == "printErr" && (E = e[C]));
          ht = h.Od, Me(), y = h.Pd, be(), Sr();
        } else if (f === "run") {
          (function($) {
            var C = (w(), L)[$ + 52 >>> 2 >>> 0];
            $ = (w(), L)[$ + 56 >>> 2 >>> 0], Fi(C, C - $), ue(C);
          })(h.Rc), Rn(h.Rc, 0, 0, 1, 0, 0), qo(), En(h.Rc), U || (Ni(), U = true);
          try {
            hp(h.Md, h.bd);
          } catch ($) {
            if ($ != "unwind") throw $;
          }
        } else h.target !== "setimmediate" && (f === "checkMailbox" ? U && br() : f && (E(`worker: received unknown command ${f}`), E(h)));
      } catch ($) {
        throw Vi(), $;
      }
    };
  ...
  }, Oe = [], ge = 0, Te = null, qe = (s) => {
    ft.length == 0 && (jo(), Ko(ft[0]));
    var l = ft.pop();
    if (!l) return 6;
    Qt.push(l), Ct[s.Rc] = l, l.Rc = s.Rc;
    var h = { Sc: "run", Md: s.Ld, bd: s.bd, Rc: s.Rc };
    return l.postMessage(h, s.jd), 0;
  }, Ne = 0, Se = (s, l, ...h) => {
    var f, $ = 16 * h.length, C = de(), P = Nn($), B = P >>> 3;
    for (f of h) typeof f == "bigint" ? ((w(), Z)[B++ >>> 0] = 1n, (w(), Z)[B++ >>> 0] = f) : ((w(), Z)[B++ >>> 0] = 0n, (w(), X)[B++ >>> 0] = f);
    return s = Li(s, 0, $, P, l), ue(C), s;
  };
  function pr(s) {
    if (o) return Se(0, 1, s);
    if (b = s, !(0 < Ne)) {
      for (var l of Qt) ve(l);
      for (l of ft) ve(l);
      ft = [], Qt = [], Ct = {}, A = true;
    }
    c(0, new ke(s));
  ...
  var vn = (s) => {
    ...
    var l = s.Rc;
    delete Ct[l], ft.push(s), Qt.splice(Qt.indexOf(s), 1), s.Rc = 0, Wi(l);
  };
  function qo() {
    Ho.forEach((s) => s());
  }
  var Ko = (s) => new Promise((l) => {
    s.onmessage = ($) => {
      var C = $.data;
      if ($ = C.Sc, C.Zc && C.Zc != xr()) {
        var P = Ct[C.Zc];
        P ? P.postMessage(C, C.jd) : E(`Internal error! Worker sent a message "${$}" to target pthread ${C.Zc}, but that thread no longer exists!`);
      } else $ === "checkMailbox" ? br() : $ === "spawnThread" ? qe(C) : $ === "cleanupThread" ? gr(() => {
        Fo(Ct[C.Nd]);
      }) : $ === "loaded" ? (s.loaded = true, l(s)) : C.target === "setimmediate" ? s.postMessage(C) : $ === "uncaughtException" ? s.onerror(C.error) : $ === "callHandler" ? e[C.vd](...C.args) : $ && E(`worker sent an unknown command ${$}`);
    }, s.onerror = ($) => {
      throw E(`worker sent an error! ${$.filename}:${$.lineno}: ${$.message}`), $;
    };
    var h, f = [];
    for (h of []) e.propertyIsEnumerable(h) && f.push(h);
    s.postMessage({ Sc: "load", xd: f, Od: ht, Pd: y });
  });
  function jo() {
    var s = new Worker((() => {
      let l = URL;
  ...
  function gp(s) {
    var l = new xn(s >>>= 0);
    return (w(), N)[l.Tc + 12 >>> 0] == 0 && (Zo(l, true), fr--), Qo(l, false), mr.push(l), ji(s);
  }
  var Vt = 0, bp = () => {
    ce(0, 0);
    var s = mr.pop();
  ...
  function Zo(s, l) {
    l = l ? 1 : 0, (w(), N)[s.Tc + 12 >>> 0] = l;
  }
  function Qo(s, l) {
    l = l ? 1 : 0, (w(), N)[s.Tc + 13 >>> 0] = l;
  }
  class xn {
    constructor(l) {
  ...
  var Sn = (s) => {
    ...
    var h = new xn(l);
    (w(), L)[h.Tc + 16 >>> 2 >>> 0] = l;
    var f = (w(), L)[h.Tc + 4 >>> 2 >>> 0];
    if (!f) return Jt(0), l;
    for (var $ of s) {
      if ($ === 0 || $ === f) break;
      if (Ki($, f, h.Tc + 16)) return Jt($), l;
    }
    return Jt(f), l;
  };
  function yp() {
  ...
  var $p = () => {
    ...
    var l = s.cd;
    throw (w(), N)[s.Tc + 13 >>> 0] == 0 && (mr.push(s), Qo(s, true), Zo(s, false), fr++), Vn(l), Vt = l;
  };
  function vp(s, l, h) {
    var f = new xn(s >>>= 0);
    throw l >>>= 0, h >>>= 0, (w(), L)[f.Tc + 16 >>> 2 >>> 0] = 0, (w(), L)[f.Tc + 4 >>> 2 >>> 0] = l, (w(), L)[f.Tc + 8 >>> 2 >>> 0] = h, Vn(s), fr++, Vt = s;
  }
  var xp = () => fr;
  function Xo(s, l, h, f) {
    return o ? Se(2, 1, s, l, h, f) : Yo(s, l, h, f);
  }
  function Yo(s, l, h, f) {
    if (s >>>= 0, l >>>= 0, h >>>= 0, f >>>= 0, !globalThis.SharedArrayBuffer) return 6;
    var $ = [];
    return o && $.length === 0 ? Xo(s, l, h, f) : (s = { Ld: h, Rc: s, bd: f, jd: $ }, o ? (s.Sc = "spawnThread", postMessage(s, $), 0) : qe(s));
  }
  function Sp(s) {
    throw Vt ||= s >>> 0, Vt;
  }
  var Jo = globalThis.TextDecoder && new TextDecoder(), ei = (s, l, h, f) => {
    ...
    for (f = ""; l < h; ) {
      ...
      if (128 & $) {
        var C = 63 & s[l++];
        if ((224 & $) == 192) f += String.fromCharCode((31 & $) << 6 | C);
        else {
          var P = 63 & s[l++];
          65536 > ($ = (240 & $) == 224 ? (15 & $) << 12 | C << 6 | P : (7 & $) << 18 | C << 12 | P << 6 | 63 & s[l++]) ? f += String.fromCharCode($) : ($ -= 65536, f += String.fromCharCode(55296 | $ >> 10, 56320 | 1023 & $));
        }
      } else f += String.fromCharCode($);
    }
    return f;
  }, Ee = (s, l, h) => (s >>>= 0) ? ti((w(), F), s, l, h) : "";
  function ri(s, l, h) {
    return o ? Se(3, 1, s, l, h) : 0;
  }
  function ni(s, l) {
    if (o) return Se(4, 1, s, l);
  }
  function oi(s, l) {
    if (o) return Se(5, 1, s, l);
  }
  function ii(s, l, h) {
    if (o) return Se(6, 1, s, l, h);
  }
  function ai(s, l, h) {
    return o ? Se(7, 1, s, l, h) : 0;
  }
  function si(s, l) {
    if (o) return Se(8, 1, s, l);
  }
  function ui(s, l, h) {
    if (o) return Se(9, 1, s, l, h);
  }
  function di(s, l, h, f) {
    if (o) return Se(10, 1, s, l, h, f);
  }
  function li(s, l, h, f) {
    if (o) return Se(11, 1, s, l, h, f);
  }
  function ci(s, l, h, f) {
    if (o) return Se(12, 1, s, l, h, f);
  }
  function pi(s) {
    if (o) return Se(13, 1, s);
  }
  function mi(s, l) {
    if (o) return Se(14, 1, s, l);
  }
  function fi(s, l, h) {
    if (o) return Se(15, 1, s, l, h);
  }
  var Tp = () => M(""), Je = (s) => {
    s >>>= 0;
    for (var l = ""; ; ) {
  ...
  }, Tn = {}, In = {}, Ip = {}, Lt = class extends Error {
    constructor(s) {
  ...
  function lt(s, l, h = {}) {
    return (function(f, $, C = {}) {
      ...
      In[f] = $, delete Ip[f], Tn.hasOwnProperty(f) && ($ = Tn[f], delete Tn[f], $.forEach((B) => B()));
    })(s, l, h);
  }
  var hi = (s, l, h) => {
    switch (l) {
      ...
      case 2:
        return h ? (f) => (w(), q)[f >>> 1 >>> 0] : (f) => (w(), Y)[f >>> 1 >>> 0];
      case 4:
        return h ? (f) => (w(), z)[f >>> 2 >>> 0] : (f) => (w(), L)[f >>> 2 >>> 0];
      case 8:
  ...
  function Cp(s, l, h, f, $) {
    ...
    if (f = f === 0n) {
      let P = 8 * h;
      C = (B) => BigInt.asUintN(P, B), $ = C($);
    }
    lt(s, { name: l, Oc: C, Vc: (P, B) => (typeof B == "number" && (B = BigInt(B)), B), Uc: hi(l, h, !f), Wc: null });
  }
  function Ap(s, l, h, f) {
    lt(s >>>= 0, { name: l = Je(l >>> 0), Oc: function($) {
      return !!$;
    }, Vc: function($, C) {
      return C ? h : f;
    }, Uc: function($) {
      return this.Oc((w(), F)[$ >>> 0]);
    }, Wc: null });
  }
  ...
  function An(s) {
    return this.Oc((w(), L)[s >>> 2 >>> 0]);
  }
  var Ep = { name: "emscripten::val", Oc: (s) => {
    var l = He(s);
    return Cn(s), l;
  }, Vc: (s, l) => Ke(l), Uc: An, Wc: null };
  function kp(s) {
    return lt(s >>> 0, Ep);
  }
  var Pp = (s, l) => {
    switch (l) {
      case 4:
        return function(h) {
          return this.Oc((w(), Q)[h >>> 2 >>> 0]);
        };
      case 8:
        return function(h) {
          return this.Oc((w(), X)[h >>> 3 >>> 0]);
        };
      default:
  ...
  function Op(s, l, h) {
    h >>>= 0, lt(s >>>= 0, { name: l = Je(l >>> 0), Oc: (f) => f, Vc: (f, $) => $, Uc: Pp(l, h), Wc: null });
  }
  function Dp(s, l, h, f, $) {
    s >>>= 0, h >>>= 0, l = Je(l >>> 0);
    let C = (B) => B;
    ...
    lt(s, { name: l, Oc: C, Vc: (B, H) => H, Uc: hi(l, h, f !== 0), Wc: null });
  }
  function zp(s, l, h) {
    function f(C) {
      var P = (w(), L)[C >>> 2 >>> 0];
      return C = (w(), L)[C + 4 >>> 2 >>> 0], new $((w(), N).buffer, C, P);
    }
    var $ = [Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array, BigInt64Array, BigUint64Array][l];
    lt(s >>>= 0, { name: h = Je(h >>> 0), Oc: f, Uc: f }, { yd: true });
  }
  var gt = (s, l, h) => {
    var f = (w(), F);
    if (l >>>= 0, 0 < h) {
  ...
  function Bp(s, l) {
    lt(s >>>= 0, { name: l = Je(l >>> 0), Oc(h) {
      var f = (w(), L)[h >>> 2 >>> 0];
      return f = Ee(h + 4, f, true), tt(h), f;
    }, Vc(h, f) {
      f instanceof ArrayBuffer && (f = new Uint8Array(f));
      var $ = typeof f == "string";
      if (!($ || ArrayBuffer.isView(f) && f.BYTES_PER_ELEMENT == 1)) throw new Lt("Cannot pass non-string to std::string");
      var C = $ ? hr(f) : f.length, P = Yt(4 + C + 1), B = P + 4;
      return (w(), L)[P >>> 2 >>> 0] = C, $ ? gt(f, B, C + 1) : (w(), F).set(f, B >>> 0), h !== null && h.push(tt, P), P;
    }, Uc: An, Wc(h) {
      tt(h);
    } });
  }
  var bi = globalThis.TextDecoder ? new TextDecoder("utf-16le") : void 0, Mp = (s, l, h) => {
    if (s >>>= 1, 16 < (l = ei((w(), Y), s, l / 2, h)) - s && bi) return bi.decode((w(), Y).slice(s, l));
    for (h = ""; s < l; ++s) {
      var f = (w(), Y)[s >>> 0];
    ...
    for (var $ = 0; $ < s.length; ++$) {
      var C = s.codePointAt($);
      if (65535 < C && $++, (w(), z)[l >>> 2 >>> 0] = C, (l += 4) + 4 > h) break;
    }
    return (w(), z)[l >>> 2 >>> 0] = 0, l - f;
  }, Lp = (s) => {
    for (var l = 0, h = 0; h < s.length; ++h) 65535 < s.codePointAt(h) && h++, l += 4;
    return l;
  };
  function Wp(s, l, h) {
    if (s >>>= 0, l >>>= 0, h = Je(h >>>= 0), l === 2) var f = Mp, $ = Rp, C = Up;
    else f = Np, $ = Vp, C = Lp;
    lt(s, { name: h, Oc: (P) => {
      var B = (w(), L)[P >>> 2 >>> 0];
      return B = f(P + 4, B * l, true), tt(P), B;
    }, Vc: (P, B) => {
      if (typeof B != "string") throw new Lt(`Cannot pass non-string to C++ string type ${h}`);
      var H = C(B), K = Yt(4 + H + l);
      return (w(), L)[K >>> 2 >>> 0] = H / l, $(B, K + 4, H + l), P !== null && P.push(tt, K), K;
    }, Uc: An, Wc(P) {
      tt(P);
    } });
  }
  function Gp(s, l) {
    lt(s >>>= 0, { zd: true, name: l = Je(l >>> 0), Oc: () => {
    }, Vc: () => {
    } });
  }
  function Hp(s) {
  ...
  }, Fp = !Atomics.waitAsync || globalThis.navigator?.userAgent && 91 > Number((navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./) || [])[2]);
  function En(s) {
    s >>>= 0, Fp || (Atomics.waitAsync((w(), z), s >>> 2, s).value.then(br), s += 128, Atomics.store((w(), z), s >>> 2, 1));
  }
  var br = () => gr(() => {
    var s = xr();
    s && (En(s), Hi());
  ...
  function qp(s, l) {
    (s >>>= 0) == l >>> 0 ? setTimeout(br) : o ? postMessage({ Zc: s, Sc: "checkMailbox" }) : (s = Ct[s]) && s.postMessage({ Sc: "checkMailbox" });
  }
  var kn = [];
  function Kp(s, l, h, f, $) {
    for (l >>>= 0, $ >>>= 0, kn.length = 0, h = $ >>> 3, f = $ + f >>> 3; h < f; ) {
      var C;
      C = (w(), Z)[h++ >>> 0] ? (w(), Z)[h++ >>> 0] : (w(), X)[h++ >>> 0], kn.push(C);
    }
    return (l ? Wn[l] : Um[s])(...kn);
  }
  var jp = () => {
    Ne = 0;
  };
  function Zp(s) {
    s >>>= 0, o ? postMessage({ Sc: "cleanupThread", Nd: s }) : Fo(Ct[s]);
  }
  function Qp(s) {
  }
  var yr = (s) => {
  ...
  function Xp(s) {
    var l = (...h) => {
      ...
      try {
        ...
        A || (_r.pop(), et && bt === 1 && _r.length === 0 && (bt = 0, Ne += 1, yr(Oa), typeof Fibers < "u" && Fibers.be()));
      }
    };
    return wi.set(s, l), l;
  }
  var bt = 0, et = null, yi = 0, _r = [], Pn = /* @__PURE__ */ new Map(), _i = /* @__PURE__ */ new Map(), wi = /* @__PURE__ */ new Map(), Yp = 0, On = null, Jp = [], $i = (s) => (function(l) {
    if (!A) {
      if (bt === 0) {
        var h = false, f = false;
        l(($ = 0) => {
          if (!A && (yi = $, h = true, f)) {
            bt = 2, yr(() => Da(et)), typeof MainLoop < "u" && MainLoop.ud && MainLoop.resume(), $ = false;
            try {
              var C = (function() {
                var H = (w(), z)[et + 8 >>> 2 >>> 0];
            ...
            if (!et) {
              var B = On;
              B && (On = null, ($ ? B.reject : B.resolve)(C), P = true);
            }
            if ($ && !P) throw C;
          }
        }), f = true, h || (bt = 1, et = (function() {
          var $ = Yt(65548), C = $ + 12;
          if ((w(), L)[$ >>> 2 >>> 0] = C, (w(), L)[$ + 4 >>> 2 >>> 0] = C + 65536, C = _r[0], !Pn.has(C)) {
            var P = Yp++;
            Pn.set(C, P), _i.set(P, C);
          }
          return C = Pn.get(C), (w(), z)[$ + 8 >>> 2 >>> 0] = C, $;
        })(), typeof MainLoop < "u" && MainLoop.ud && MainLoop.pause(), yr(() => Pa(et)));
      } else bt === 2 ? (bt = 0, yr(za), tt(et), et = null, Jp.forEach(gr)) : M(`invalid state: ${bt}`);
      return yi;
    }
  })((l) => {
    s().then(l);
  ...
  var Dn = [], tm = (s) => {
    ...
    for (var h = Array(s), f = 0; f < s; ++f) {
      var $ = f, C = (w(), L)[l + 4 * f >>> 2 >>> 0], P = In[C];
      if (P === void 0) throw s = `parameter ${f}`, C = Ui(C), l = Je(C), tt(C), new Lt(`${s} has unknown type ${l}`);
      h[$] = P;
    }
    return h;
  }, nm = (s, l, h) => {
  ...
  function im(s, l, h) {
    ...
    switch (s = C.map((H, K) => {
      ...
      case 3:
        ...
        break;
      case 1:
        P.getStringOrSymbol = wr, B = "toValue(handle)[getStringOrSymbol(methodName)]";
    }
    return B += `(${s})`, f.zd || (P.toReturnWire = l, P.emval_returnValue = nm, B = `return emval_returnValue(toReturnWire, destructorsRef, ${B})`), B = `return function (handle, methodName, destructorsRef, args) {
  ${B}
  }`, h = new Function(Object.keys(P), B)(...Object.values(P)), B = `methodCaller<(${$.map((H) => H.name)}) => ${f.name}>`, tm(Object.defineProperty(h, "name", { value: B }));
  }
  function am(s, l) {
  ...
  function vi(s, l, h, f, $) {
    return Dn[s >>> 0](l >>> 0, h >>> 0, f >>> 0, $ >>> 0);
  }
  function cm(s, l, h, f, $) {
    return vi(s >>> 0, l >>> 0, h >>> 0, f >>> 0, $ >>> 0);
  }
  function pm() {
    return Ke([]);
  }
  ...
  function _m(s, l) {
    s = -9007199254740992 > s || 9007199254740992 < s ? NaN : Number(s), l >>>= 0, s = new Date(1e3 * s), (w(), z)[l >>> 2 >>> 0] = s.getSeconds(), (w(), z)[l + 4 >>> 2 >>> 0] = s.getMinutes(), (w(), z)[l + 8 >>> 2 >>> 0] = s.getHours(), (w(), z)[l + 12 >>> 2 >>> 0] = s.getDate(), (w(), z)[l + 16 >>> 2 >>> 0] = s.getMonth(), (w(), z)[l + 20 >>> 2 >>> 0] = s.getFullYear() - 1900, (w(), z)[l + 24 >>> 2 >>> 0] = s.getDay();
    var h = (xi(s.getFullYear()) ? Si : Ti)[s.getMonth()] + s.getDate() - 1 | 0;
    (w(), z)[l + 28 >>> 2 >>> 0] = h, (w(), z)[l + 36 >>> 2 >>> 0] = -60 * s.getTimezoneOffset(), h = new Date(s.getFullYear(), 6, 1).getTimezoneOffset();
    var f = new Date(s.getFullYear(), 0, 1).getTimezoneOffset();
    s = 0 | (h != f && s.getTimezoneOffset() == Math.min(f, h)), (w(), z)[l + 32 >>> 2 >>> 0] = s;
  }
  function wm(s) {
    s >>>= 0;
    var l = new Date((w(), z)[s + 20 >>> 2 >>> 0] + 1900, (w(), z)[s + 16 >>> 2 >>> 0], (w(), z)[s + 12 >>> 2 >>> 0], (w(), z)[s + 8 >>> 2 >>> 0], (w(), z)[s + 4 >>> 2 >>> 0], (w(), z)[s >>> 2 >>> 0], 0), h = (w(), z)[s + 32 >>> 2 >>> 0], f = l.getTimezoneOffset(), $ = new Date(l.getFullYear(), 6, 1).getTimezoneOffset(), C = new Date(l.getFullYear(), 0, 1).getTimezoneOffset(), P = Math.min(C, $);
    return 0 > h ? (w(), z)[s + 32 >>> 2 >>> 0] = +($ != C && P == f) : 0 < h != (P == f) && ($ = Math.max(C, $), l.setTime(l.getTime() + 6e4 * ((0 < h ? P : $) - f))), (w(), z)[s + 24 >>> 2 >>> 0] = l.getDay(), h = (xi(l.getFullYear()) ? Si : Ti)[l.getMonth()] + l.getDate() - 1 | 0, (w(), z)[s + 28 >>> 2 >>> 0] = h, (w(), z)[s >>> 2 >>> 0] = l.getSeconds(), (w(), z)[s + 4 >>> 2 >>> 0] = l.getMinutes(), (w(), z)[s + 8 >>> 2 >>> 0] = l.getHours(), (w(), z)[s + 12 >>> 2 >>> 0] = l.getDate(), (w(), z)[s + 16 >>> 2 >>> 0] = l.getMonth(), (w(), z)[s + 20 >>> 2 >>> 0] = l.getYear(), s = l.getTime(), BigInt(isNaN(s) ? -1 : s / 1e3);
  }
  function Ii(s, l, h, f, $, C, P) {
    return o ? Se(16, 1, s, l, h, f, $, C, P) : -52;
  }
  function Ci(s, l, h, f, $, C) {
    if (o) return Se(17, 1, s, l, h, f, $, C);
  }
  var Xt = {}, $m = () => performance.timeOrigin + performance.now();
  function Ai(s, l) {
    if (o) return Se(18, 1, s, l);
    if (Xt[s] && (clearTimeout(Xt[s].id), delete Xt[s]), !l) return 0;
    var h = setTimeout(() => {
      delete Xt[s], gr(() => Gi(s, performance.timeOrigin + performance.now()));
    }, l);
    return Xt[s] = { id: h, ae: l }, 0;
  }
  function vm(s, l, h, f) {
    s >>>= 0, l >>>= 0, h >>>= 0, f >>>= 0;
    var $ = (/* @__PURE__ */ new Date()).getFullYear(), C = new Date($, 0, 1).getTimezoneOffset();
    $ = new Date($, 6, 1).getTimezoneOffset();
    var P = Math.max(C, $);
    (w(), L)[s >>> 2 >>> 0] = 60 * P, (w(), z)[l >>> 2 >>> 0] = +(C != $), s = (l = (B) => {
      var H = Math.abs(B);
      return `UTC${0 <= B ? "-" : "+"}${String(Math.floor(H / 60)).padStart(2, "0")}${String(H % 60).padStart(2, "0")}`;
    })(C), l = l($), $ < C ? (gt(s, h, 17), gt(l, f, 17)) : (gt(s, f, 17), gt(l, h, 17));
  }
  var xm = () => Date.now(), Sm = 1;
  function Tm(s, l, h) {
  ...
  var zn = [], Ei = (s, l) => {
    ...
    for (var h; h = (w(), F)[s++ >>> 0]; ) {
      var f = h != 105;
      l += (f &= h != 112) && l % 8 ? 4 : 0, zn.push(h == 112 ? (w(), L)[l >>> 2 >>> 0] : h == 106 ? (w(), Z)[l >>> 3 >>> 0] : h == 105 ? (w(), z)[l >>> 2 >>> 0] : (w(), X)[l >>> 3 >>> 0]), l += f ? 8 : 4;
    }
    return zn;
  };
  function Im(s, l, h) {
  ...
  var Om = () => navigator.hardwareConcurrency, Et = {}, $r = (s) => {
    var l;
    return (l = /\bwasm-function\[\d+\]:(0x[0-9a-f]+)/.exec(s)) ? +l[1] : (l = /:(\d+):\d+(?:\)|$)/.exec(s)) ? 2147483648 | +l[1] : 0;
  }, ki = (s) => {
    for (var l of s) (s = $r(l)) && (Et[s] = l);
  };
  function Dm() {
    var s = Error().stack.toString().split(`
`);
    return s[0] == "Error" && s.shift(), ki(s), Et.gd = $r(s[3]), Et.Jd = s, Et.gd;
  }
  function vr(s) {
    ...
    tt(vr.hd ?? 0), l = hr(s) + 1;
    var h = Yt(l);
    return h && gt(s, h, l), vr.hd = h, vr.hd;
  }
  function zm(s) {
    s >>>= 0;
    var l = (w(), F).length;
  ...
  function Bm(s, l, h) {
    if (s >>>= 0, l >>>= 0, Et.gd == s) var f = Et.Jd;
    else (f = Error().stack.toString().split(`
`))[0] == "Error" && f.shift(), ki(f);
    for (var $ = 3; f[$] && $r(f[$]) != s; ) ++$;
    for (s = 0; s < h && f[s + $]; ++s) (w(), z)[l + 4 * s >>> 2 >>> 0] = $r(f[s + $]);
    return s;
  }
  var Bn, Mn = {}, Pi = () => {
    if (!Bn) {
  ...
  function Oi(s, l) {
    if (o) return Se(19, 1, s, l);
    s >>>= 0, l >>>= 0;
    var h, f = 0, $ = 0;
    for (h of Pi()) {
      var C = l + f;
      (w(), L)[s + $ >>> 2 >>> 0] = C, f += gt(h, C, 1 / 0) + 1, $ += 4;
    }
    return 0;
  }
  function Di(s, l) {
    if (o) return Se(20, 1, s, l);
    s >>>= 0, l >>>= 0;
    var h = Pi();
  ...
  function zi(s) {
    return o ? Se(21, 1, s) : 52;
  }
  function Bi(s, l, h, f) {
    return o ? Se(22, 1, s, l, h, f) : 52;
  }
  function Mi(s, l, h, f) {
    return o ? Se(23, 1, s, l, h, f) : 70;
  }
  var Mm = [null, [], []];
  function Ri(s, l, h, f) {
    if (o) return Se(24, 1, s, l, h, f);
    l >>>= 0, h >>>= 0, f >>>= 0;
    for (var $ = 0, C = 0; C < h; C++) {
      var P = (w(), L)[l >>> 2 >>> 0], B = (w(), L)[l + 4 >>> 2 >>> 0];
      l += 8;
      for (var H = 0; H < B; H++) {
        var K = s, ae = (w(), F)[P + H >>> 0], pe = Mm[K];
        ae === 0 || ae === 10 ? ((K === 1 ? I : E)(ti(pe)), pe.length = 0) : pe.push(ae);
      }
      $ += B;
    }
    return (w(), L)[f >>> 2 >>> 0] = $, 0;
  ...
  var Ui, Ni, xr, tt, Yt, Rn, Vi, Li, Wi, Un, Gi, Hi, ce, Jt, Fi, ue, Nn, de, qi, Vn, Ki, ji, Zi, Ln, Qi, Xi, Yi, Ji, ea, ta, ra, na, oa, ia, aa, sa, ua, da, la, ca, pa, ma, fa, ha, ga, ba, ya, _a, wa, $a, va, xa, Sa, Ta, Ia, Ca, Aa, Ea, ka, Pa, Oa, Da, za, ct, Um = [pr, Go, Xo, ri, ni, oi, ii, ai, si, ui, di, li, ci, pi, mi, fi, Ii, Ci, Ai, Oi, Di, zi, Bi, Mi, Ri], Wn = { 1055492: (s, l, h, f, $) => {
    if (e === void 0 || !e.Yc) return 1;
    if ((s = Ee(Number(s >>> 0))).startsWith("./") && (s = s.substring(2)), !(s = e.Yc.get(s))) return 2;
    ...
    e.td(s, (w(), F).subarray(l >>> 0, l + h >>> 0));
  }, 1056380: () => e.Sd(), 1056422: (s) => {
    e.sd(s);
  }, 1056459: () => {
    e.Bd();
  }, 1056490: () => {
    ...
    e.Gd();
  }, 1056544: (s) => e.Ad(s), 1056577: (s) => e.Ed(s), 1056609: (s, l, h) => {
    e.ed(Number(s), Number(l), Number(h), true);
  }, 1056672: (s, l, h) => {
    e.ed(Number(s), Number(l), Number(h));
  }, 1056729: () => typeof wasmOffsetConverter < "u", 1056786: (s) => {
    e.$b("Abs", s, void 0);
  }, 1056837: (s) => {
    e.$b("Neg", s, void 0);
  }, 1056888: (s) => {
    ...
    e.$b("Sigmoid", s, void 0);
  }, 1057260: (s, l, h) => {
    e.$b("HardSigmoid", s, { alpha: l, beta: h });
  }, 1057339: (s) => {
    e.$b("HardSwish", s, void 0);
  }, 1057396: (s) => {
    e.$b("Log", s, void 0);
  }, 1057447: (s) => {
    e.$b("Sin", s, void 0);
    ...
    e.$b("LeakyRelu", s, { alpha: l });
  }, 1058469: (s, l) => {
    e.$b("ThresholdedRelu", s, { alpha: l });
  }, 1058539: (s, l) => {
    e.$b("Cast", s, { to: l });
  }, 1058597: (s) => {
    e.$b("Add", s, void 0);
    ...
    e.$b("Greater", s, void 0);
  }, 1058960: (s) => {
    e.$b("GreaterOrEqual", s, void 0);
  }, 1059022: (s) => {
    e.$b("Less", s, void 0);
  }, 1059074: (s) => {
    e.$b("LessOrEqual", s, void 0);
  }, 1059133: (s, l, h, f, $) => {
    e.$b("ReduceMean", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((w(), z).subarray(Number(f) >>> 0, Number($) >>> 0)) : [] });
  }, 1059308: (s, l, h, f, $) => {
    e.$b("ReduceMax", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((w(), z).subarray(Number(f) >>> 0, Number($) >>> 0)) : [] });
  }, 1059482: (s, l, h, f, $) => {
    e.$b("ReduceMin", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((w(), z).subarray(Number(f) >>> 0, Number($) >>> 0)) : [] });
  }, 1059656: (s, l, h, f, $) => {
    e.$b("ReduceProd", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((w(), z).subarray(Number(f) >>> 0, Number($) >>> 0)) : [] });
  }, 1059831: (s, l, h, f, $) => {
    e.$b("ReduceSum", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((w(), z).subarray(Number(f) >>> 0, Number($) >>> 0)) : [] });
  }, 1060005: (s, l, h, f, $) => {
    e.$b("ReduceL1", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((w(), z).subarray(Number(f) >>> 0, Number($) >>> 0)) : [] });
  }, 1060178: (s, l, h, f, $) => {
    e.$b("ReduceL2", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((w(), z).subarray(Number(f) >>> 0, Number($) >>> 0)) : [] });
  }, 1060351: (s, l, h, f, $) => {
    e.$b("ReduceLogSum", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((w(), z).subarray(Number(f) >>> 0, Number($) >>> 0)) : [] });
  }, 1060528: (s, l, h, f, $) => {
    e.$b("ReduceSumSquare", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((w(), z).subarray(Number(f) >>> 0, Number($) >>> 0)) : [] });
  }, 1060708: (s, l, h, f, $) => {
    e.$b("ReduceLogSumExp", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((w(), z).subarray(Number(f) >>> 0, Number($) >>> 0)) : [] });
  }, 1060888: (s) => {
    e.$b("Where", s, void 0);
  }, 1060941: (s, l, h) => {
    e.$b("Transpose", s, { perm: l ? Array.from((w(), z).subarray(Number(l) >>> 0, Number(h) >>> 0)) : [] });
  }, 1061065: (s, l, h, f) => {
    e.$b("DepthToSpace", s, { blocksize: l, mode: Ee(h), format: f ? "NHWC" : "NCHW" });
  }, 1061198: (s, l, h, f) => {
    e.$b("DepthToSpace", s, { blocksize: l, mode: Ee(h), format: f ? "NHWC" : "NCHW" });
  }, 1061331: (s, l, h, f) => {
    e.$b("DFT", s, { axis: l, inverse: h, onesided: f });
  }, 1061423: (s, l, h, f, $, C, P, B, H, K, ae, pe, xe, Ie, yt) => {
    e.$b("ConvTranspose", s, { format: H ? "NHWC" : "NCHW", autoPad: l, dilations: [h], group: f, kernelShape: [$], pads: [C, P], strides: [B], wIsConst: () => !!(w(), N)[K >>> 0], outputPadding: ae ? Array.from((w(), z).subarray(Number(ae) >>> 0, Number(pe) >>> 0)) : [], outputShape: xe ? Array.from((w(), z).subarray(Number(xe) >>> 0, Number(Ie) >>> 0)) : [], activation: Ee(yt) });
  }, 1061856: (s, l, h, f, $, C, P, B, H, K, ae, pe, xe, Ie) => {
    e.$b("ConvTranspose", s, { format: B ? "NHWC" : "NCHW", autoPad: l, dilations: Array.from((w(), z).subarray(Number(h) >>> 0, (Number(h) >>> 0) + 2 >>> 0)), group: f, kernelShape: Array.from((w(), z).subarray(Number($) >>> 0, (Number($) >>> 0) + 2 >>> 0)), pads: Array.from((w(), z).subarray(Number(C) >>> 0, (Number(C) >>> 0) + 4 >>> 0)), strides: Array.from((w(), z).subarray(Number(P) >>> 0, (Number(P) >>> 0) + 2 >>> 0)), wIsConst: () => !!(w(), N)[H >>> 0], outputPadding: K ? Array.from((w(), z).subarray(Number(K) >>> 0, Number(ae) >>> 0)) : [], outputShape: pe ? Array.from((w(), z).subarray(Number(pe) >>> 0, Number(xe) >>> 0)) : [], activation: Ee(Ie) });
  }, 1062517: (s, l, h, f, $, C, P, B, H, K, ae, pe, xe, Ie, yt) => {
    e.$b("ConvTranspose", s, { format: H ? "NHWC" : "NCHW", autoPad: l, dilations: [h], group: f, kernelShape: [$], pads: [C, P], strides: [B], wIsConst: () => !!(w(), N)[K >>> 0], outputPadding: ae ? Array.from((w(), z).subarray(Number(ae) >>> 0, Number(pe) >>> 0)) : [], outputShape: xe ? Array.from((w(), z).subarray(Number(xe) >>> 0, Number(Ie) >>> 0)) : [], activation: Ee(yt) });
  }, 1062950: (s, l, h, f, $, C, P, B, H, K, ae, pe, xe, Ie) => {
    e.$b("ConvTranspose", s, { format: B ? "NHWC" : "NCHW", autoPad: l, dilations: Array.from((w(), z).subarray(Number(h) >>> 0, (Number(h) >>> 0) + 2 >>> 0)), group: f, kernelShape: Array.from((w(), z).subarray(Number($) >>> 0, (Number($) >>> 0) + 2 >>> 0)), pads: Array.from((w(), z).subarray(Number(C) >>> 0, (Number(C) >>> 0) + 4 >>> 0)), strides: Array.from((w(), z).subarray(Number(P) >>> 0, (Number(P) >>> 0) + 2 >>> 0)), wIsConst: () => !!(w(), N)[H >>> 0], outputPadding: K ? Array.from((w(), z).subarray(Number(K) >>> 0, Number(ae) >>> 0)) : [], outputShape: pe ? Array.from((w(), z).subarray(Number(pe) >>> 0, Number(xe) >>> 0)) : [], activation: Ee(Ie) });
  }, 1063611: (s, l) => {
    e.$b("GlobalAveragePool", s, { format: l ? "NHWC" : "NCHW" });
  }, 1063702: (s, l, h, f, $, C, P, B, H, K, ae, pe, xe, Ie) => {
    ...
    e.$b("GlobalAveragePool", s, { format: l ? "NHWC" : "NCHW" });
  }, 1064272: (s, l, h, f, $, C, P, B, H, K, ae, pe, xe, Ie) => {
    e.$b("AveragePool", s, { format: Ie ? "NHWC" : "NCHW", auto_pad: l, ceil_mode: h, count_include_pad: f, storage_order: $, dilations: C ? Array.from((w(), z).subarray(Number(C) >>> 0, Number(P) >>> 0)) : [], kernel_shape: B ? Array.from((w(), z).subarray(Number(B) >>> 0, Number(H) >>> 0)) : [], pads: K ? Array.from((w(), z).subarray(Number(K) >>> 0, Number(ae) >>> 0)) : [], strides: pe ? Array.from((w(), z).subarray(Number(pe) >>> 0, Number(xe) >>> 0)) : [] });
  }, 1064751: (s, l) => {
    e.$b("GlobalMaxPool", s, { format: l ? "NHWC" : "NCHW" });
  }, 1064838: (s, l, h, f, $, C, P, B, H, K, ae, pe, xe, Ie) => {
    e.$b("MaxPool", s, { format: Ie ? "NHWC" : "NCHW", auto_pad: l, ceil_mode: h, count_include_pad: f, storage_order: $, dilations: C ? Array.from((w(), z).subarray(Number(C) >>> 0, Number(P) >>> 0)) : [], kernel_shape: B ? Array.from((w(), z).subarray(Number(B) >>> 0, Number(H) >>> 0)) : [], pads: K ? Array.from((w(), z).subarray(Number(K) >>> 0, Number(ae) >>> 0)) : [], strides: pe ? Array.from((w(), z).subarray(Number(pe) >>> 0, Number(xe) >>> 0)) : [] });
  }, 1065313: (s, l) => {
    e.$b("GlobalMaxPool", s, { format: l ? "NHWC" : "NCHW" });
  }, 1065400: (s, l, h, f, $, C, P, B, H, K, ae, pe, xe, Ie) => {
    e.$b("MaxPool", s, { format: Ie ? "NHWC" : "NCHW", auto_pad: l, ceil_mode: h, count_include_pad: f, storage_order: $, dilations: C ? Array.from((w(), z).subarray(Number(C) >>> 0, Number(P) >>> 0)) : [], kernel_shape: B ? Array.from((w(), z).subarray(Number(B) >>> 0, Number(H) >>> 0)) : [], pads: K ? Array.from((w(), z).subarray(Number(K) >>> 0, Number(ae) >>> 0)) : [], strides: pe ? Array.from((w(), z).subarray(Number(pe) >>> 0, Number(xe) >>> 0)) : [] });
  }, 1065875: (s, l, h, f, $) => {
    e.$b("Gemm", s, { alpha: l, beta: h, transA: f, transB: $ });
  }, 1065979: (s) => {
    e.$b("MatMul", s, void 0);
  }, 1066033: (s, l, h, f) => {
    e.$b("ArgMax", s, { keepDims: !!l, selectLastIndex: !!h, axis: f });
  }, 1066141: (s, l, h, f) => {
    e.$b("ArgMin", s, { keepDims: !!l, selectLastIndex: !!h, axis: f });
  }, 1066249: (s, l) => {
    e.$b("Softmax", s, { axis: l });
  }, 1066312: (s, l) => {
    e.$b("Concat", s, { axis: l });
  }, 1066372: (s, l, h, f, $) => {
    e.$b("Split", s, { axis: l, numOutputs: h, splitSizes: f ? Array.from((w(), z).subarray(Number(f) >>> 0, Number($) >>> 0)) : [] });
  }, 1066528: (s) => {
    e.$b("Expand", s, void 0);
  }, 1066582: (s, l) => {
    e.$b("Gather", s, { axis: Number(l) });
  }, 1066653: (s, l) => {
    e.$b("GatherElements", s, { axis: Number(l) });
  }, 1066732: (s, l) => {
    e.$b("GatherND", s, { batch_dims: Number(l) });
  }, 1066811: (s, l, h, f, $, C, P, B, H, K, ae) => {
    e.$b("Resize", s, { antialias: l, axes: h ? Array.from((w(), z).subarray(Number(h) >>> 0, Number(f) >>> 0)) : [], coordinateTransformMode: Ee($), cubicCoeffA: C, excludeOutside: P, extrapolationValue: B, keepAspectRatioPolicy: Ee(H), mode: Ee(K), nearestMode: Ee(ae) });
  }, 1067173: (s, l, h, f, $, C, P) => {
    e.$b("Slice", s, { starts: l ? Array.from((w(), z).subarray(Number(l) >>> 0, Number(h) >>> 0)) : [], ends: f ? Array.from((w(), z).subarray(Number(f) >>> 0, Number($) >>> 0)) : [], axes: C ? Array.from((w(), z).subarray(Number(C) >>> 0, Number(P) >>> 0)) : [] });
  }, 1067437: (s) => {
    e.$b("Tile", s, void 0);
  }, 1067489: (s, l, h) => {
    e.$b("InstanceNormalization", s, { epsilon: l, format: h ? "NHWC" : "NCHW" });
  }, 1067603: (s, l, h) => {
    e.$b("InstanceNormalization", s, { epsilon: l, format: h ? "NHWC" : "NCHW" });
  }, 1067717: (s) => {
    e.$b("Range", s, void 0);
  }, 1067770: (s, l) => {
    e.$b("Einsum", s, { equation: Ee(l) });
  }, 1067851: (s, l, h, f, $) => {
    e.$b("Pad", s, { mode: l, value: h, pads: f ? Array.from((w(), z).subarray(Number(f) >>> 0, Number($) >>> 0)) : [] });
  }, 1067994: (s, l, h, f, $, C) => {
    e.$b("BatchNormalization", s, { epsilon: l, momentum: h, spatial: !!$, trainingMode: !!f, format: C ? "NHWC" : "NCHW" });
  }, 1068163: (s, l, h, f, $, C) => {
    e.$b("BatchNormalization", s, { epsilon: l, momentum: h, spatial: !!$, trainingMode: !!f, format: C ? "NHWC" : "NCHW" });
  }, 1068332: (s, l, h) => {
    e.$b("CumSum", s, { exclusive: Number(l), reverse: Number(h) });
  }, 1068429: (s, l, h) => {
    e.$b("DequantizeLinear", s, { axis: l, blockSize: h });
  }, 1068519: (s, l, h, f, $) => {
    e.$b("GridSample", s, { align_corners: l, mode: Ee(h), padding_mode: Ee(f), format: $ ? "NHWC" : "NCHW" });
  }, 1068689: (s, l, h, f, $) => {
    e.$b("GridSample", s, { align_corners: l, mode: Ee(h), padding_mode: Ee(f), format: $ ? "NHWC" : "NCHW" });
  }, 1068859: (s, l) => {
    e.$b("ScatterND", s, { reduction: Ee(l) });
  }, 1068944: (s, l, h, f, $, C, P, B, H) => {
    e.$b("Attention", s, { numHeads: l, isUnidirectional: h, maskFilterValue: f, scale: $, doRotary: C, qkvHiddenSizes: P ? Array.from((w(), z).subarray(Number(B) >>> 0, Number(B) + P >>> 0)) : [], pastPresentShareBuffer: !!H });
  }, 1069216: (s) => {
    e.$b("BiasAdd", s, void 0);
  }, 1069271: (s) => {
    e.$b("BiasSplitGelu", s, void 0);
  }, 1069332: (s) => {
    e.$b("FastGelu", s, void 0);
  }, 1069388: (s, l, h, f, $, C, P, B, H, K, ae, pe, xe, Ie, yt, Gn) => {
    e.$b("Conv", s, { format: pe ? "NHWC" : "NCHW", auto_pad: l, dilations: h ? Array.from((w(), z).subarray(Number(h) >>> 0, Number(f) >>> 0)) : [], group: $, kernel_shape: C ? Array.from((w(), z).subarray(Number(C) >>> 0, Number(P) >>> 0)) : [], pads: B ? Array.from((w(), z).subarray(Number(B) >>> 0, Number(H) >>> 0)) : [], strides: K ? Array.from((w(), z).subarray(Number(K) >>> 0, Number(ae) >>> 0)) : [], w_is_const: () => !!(w(), N)[Number(xe) >>> 0], activation: Ee(Ie), activation_params: yt ? Array.from((w(), Q).subarray(Number(yt) >>> 0, Number(Gn) >>> 0)) : [] });
  }, 1069972: (s) => {
    e.$b("Gelu", s, void 0);
  }, 1070024: (s, l, h, f, $, C, P, B, H) => {
    e.$b("GroupQueryAttention", s, { numHeads: l, kvNumHeads: h, scale: f, softcap: $, doRotary: C, rotaryInterleaved: P, smoothSoftmax: B, localWindowSize: H });
  }, 1070241: (s, l, h, f) => {
    e.$b("LayerNormalization", s, { axis: l, epsilon: h, simplified: !!f });
  }, 1070352: (s, l, h, f) => {
    e.$b("LayerNormalization", s, { axis: l, epsilon: h, simplified: !!f });
  }, 1070463: (s, l, h, f, $, C) => {
    e.$b("MatMulNBits", s, { k: l, n: h, accuracyLevel: f, bits: $, blockSize: C });
  }, 1070590: (s, l, h, f, $, C) => {
    e.$b("MultiHeadAttention", s, { numHeads: l, isUnidirectional: h, maskFilterValue: f, scale: $, doRotary: C });
  }, 1070749: (s, l) => {
    e.$b("QuickGelu", s, { alpha: l });
  }, 1070813: (s, l, h, f, $) => {
    e.$b("RotaryEmbedding", s, { interleaved: !!l, numHeads: h, rotaryEmbeddingDim: f, scale: $ });
  }, 1070952: (s, l, h) => {
    e.$b("SkipLayerNormalization", s, { epsilon: l, simplified: !!h });
  }, 1071054: (s, l, h) => {
    e.$b("SkipLayerNormalization", s, { epsilon: l, simplified: !!h });
  }, 1071156: (s, l, h, f) => {
    e.$b("GatherBlockQuantized", s, { gatherAxis: l, quantizeAxis: h, blockSize: f });
  }, 1071277: (s) => {
    e.Fd(s);
  }, 1071311: (s, l) => e.Hd(Number(s), Number(l), e.Xc.Kd, e.Xc.errors) };
  function Nm(s, l, h) {
    return $i(async () => {
      await e.Dd(Number(s), Number(l), Number(h));
    });
  }
  function Vm() {
  ...
  function Km(s, l, h, f, $, C, P) {
    var B = de();
    try {
      return ta(s, l, h, f, $, C, P);
    } catch (H) {
      if (ue(B), H !== H + 0) throw H;
      ce(1, 0);
    }
  }
  function jm(s, l, h, f, $, C) {
    var P = de();
    try {
      Xi(s, l, h, f, $, C);
    } catch (B) {
  ...
  function nf(s, l, h, f, $, C, P, B, H, K, ae, pe) {
    var xe = de();
    try {
      ua(s, l, h, f, $, C, P, B, H, K, ae, pe);
    } catch (Ie) {
  ...
  function hf(s, l, h, f, $, C, P, B) {
    var H = de();
    try {
      return la(s, l, h, f, $, C, P, B);
    } catch (K) {
      if (ue(H), K !== K + 0) throw K;
      ce(1, 0);
    }
  ...
  function _f(s, l, h, f, $, C, P, B, H, K, ae, pe) {
    var xe = de();
    try {
      return Ea(s, l, h, f, $, C, P, B, H, K, ae, pe);
    } catch (Ie) {
      if (ue(xe), Ie !== Ie + 0) throw Ie;
      ce(1, 0);
    }
  }
  function wf(s, l, h, f, $, C, P, B, H, K, ae) {
    var pe = de();
    try {
      wa(s, l, h, f, $, C, P, B, H, K, ae);
    } catch (xe) {
      if (ue(pe), xe !== xe + 0) throw xe;
      ce(1, 0);
    }
  }
  function $f(s, l, h, f, $, C, P, B, H, K, ae, pe, xe, Ie, yt, Gn) {
    var Tf = de();
    try {
      $a(s, l, h, f, $, C, P, B, H, K, ae, pe, xe, Ie, yt, Gn);
    } catch (Hn) {
      if (ue(Tf), Hn !== Hn + 0) throw Hn;
      ce(1, 0);
    }
  }
  function vf(s, l, h) {
  ...
  function Sr() {
    if (0 < ge) Te = Sr;
      ...
      for (var s = Oe; 0 < s.length; ) s.shift()(e);
      0 < ge ? Te = Sr : (e.calledRun = true, A || ($e(), _?.(e)));
    }
  }
  return o || (ct = await be(), Sr()), e.PTR_SIZE = 4, le ? e : new Promise((s, l) => {
    _ = s, S = l;
  });
}
var Fn, If, Cf, Af, qn, V, Wt, Ef, er, Tr, kt, Pt, kf, Ba, Kn, Ma, Ra, Ua, Na, De, jn, _e, Va, La, Wa, Ga, Zn, Ha, Fa, qa, Ka, ja, Za, Ot, tr, Qa, Xa, Ya, Ja, es, ts, Be, Ir, je, Qn, Cr, rs, Ve, Re, _t, wt, Xn, Ar, ns, Pf, os, is, as, ss, us, Yn, Le, Er, ps, ls, cs, Of, ms, hs, Df, zf, gs, _s, to, Bf, We, ws, eo, Mf, Rf, $s, Uf, bs, vs, ys, xs, kr, ro, no, Nr, Ss, Nf, Vf, Lf, Pr, ye, $t, Ge, nr, me, Vr, Ts, Is, Wf, Gf, Hf, Gt, Ff, Cs, As, vt, rt, xt, Ht, or, Lr, Wr, oo, ee, ir, io, qf, Kf, Es, ks, Gr, jf, se, nt, ao, ot, k, zt, Hr, Ps, Os, te, Fr, so, zs, Zf, Bs, Qf, Ds, Xf, Ms, qr, Kr, uo, Rs, Us, jr, Yf, Zr, Ns, Qr, Vs, lo, co, Jf, eh, Ls, mo, po, Gs, Hs, fo, J, Ce, Bt, go, we, Ae, W, fe, bo, Mt, Ze, j, Xr, O, R, Fs, Yr, ho, qs, oe, th, Ks, rh, nh, oh, ih, ze, js, Zs, pt, ah, sh, uh, dh, lh, ch, ph, mh, fh, hh, it, Qs, Xs, Ys, Js, eu, tu, ru, nu, ou, iu, au, at, gh, en, yo, st, bh, yh, _h, wh, $h, vh, xh, Sh, Th, Ih, ut, su, uu, du, lu, cu, pu, mu, fu, hu, gu, Jr, bu, yu, _u, _o, wu, Ch, wo, Ah, Eh, kh, Ft, Ph, $u, tn, Oh, Dh, zh, vu, xu, Bh, Mh, Su, Tu, Rh, he, Iu, Cu, Au, Eu, ku, Pu, Ou, Du, zu, Uh, Bu, Mu, Ru, Uu, ar, Nu, rn, Vu, Lu, Wu, Gu, Hu, Fu, qu, Ku, ju, Zu, Qu, Xu, Yu, Ju, ed, td, rd, nd, od, $o, vo, id, ad, sd, Nh, Vh, ud, nn, Lh, Wh, ld, cd, Gh, Hh, dt, pd, md, fd, hd, gd, bd, yd, _d, wd, $d, vd, qh, Kh, jh, Zh, xd, Sd, Td, Qe, Xe, Ye, on, St, Pe, Id, an, Cd, Ad, sr, sn, un, Qh, Xh, xo, Ed, Yh, So, Jh, ur, dn, eg, kd, Pd, tg, Od, ln, rg, Dd, ng, zd, Bd, Md, Rd, Ud, Nd, og, To, ig, Io, Co, Vd, ag, sg, Ao, Ld, Wd, Gd, ug, dg, lg, Hd, Fd, cg, qd, pg, Kd, jd, mg, Zd, Qd, Xd, fg, hg, gg, Yd, Jd, el, Tt, cn, Eo, rl, Rt, bg, yg, _g, nl, ol, il, wg, $g, tl, vg, al, sl, ul, ko, pn, dl, xg, Sg, Po, Oo, ll, Tg, cl, pl, ml, Ig, fl, Cg, Ag, hl, gl, Eg, bl, yl, kg, Pg, _l, wl, $l, Og, vl, xl, Sl, Dg, zg, Tl, Il, Cl, Bg, Mg, Al, El, kl, Rg, Ug, Pl, Ol, Dl, mt, It, qt, Kt, Ng, Vg, Lg, Wg, Gg, Hg, Fg, qg, zl, Bl, Ml, Ue, Zg, Ul, Rl, Qg, dr, Nl, Do, Xg, Yg, Jg, eb, zo, Vl, Ll, Bo, tb, mn, Wl, Mo, rb, nb, Gl, ob, Hl, Fl, ql, ib, ab, Kl, jl, sb, ub, Zl, Ql, db, Xl, Yl, lb, cb, pb, Jl, ec, tc, mb, fb, hb, gb, bb, yb, _b, wb, rc, nc, fn, oc, ic, ac, sc, $b, vb, uc, dc, lc, cc, pc, mc, fc, hc, gc, bc, yc, _c, wc, Sb, Tb, $c, vc, xc, Ib, Cb, Sc, Tc, Ab, Eb, Ic, Cc, Ac, kb, Pb, Ob, Ec, Db, zb, Bb, Mb, Rb, Ub, Nb, Vb, kc, Lb, Wb, Gb, Hb, Fb, Pc, Oc, Dc, qb, Kb, zc, Bc, jb, hn, Zb, Mc, Qb, Xb, Rc, Uc, Nc, Yb, Jb, Vc, Lc, Wc, Gc, ey, ty, ry, Hc, Fc, ny, oy, qc, Kc, jc, Zc, gn, Qc, Xc, iy, ay, Ro, Uo, Yc, Jc, lr, No, sy, ep, uy, Or, Dr, Ut, dy, tp, rr, zr, Br, rp, Mr, Rr, Ur, Jn, Nt, Fe, cr, yn, _n, bn, Vo, Lo, jt, Zt, cy, np, op, ip, ap, sp, up, dp, Wo, lp, py, wn, cp, mp, pp, $n, my, fp, ds, PT;
var init_ort_bundle_min = __esm({
  "node_modules/onnxruntime-web/dist/ort.bundle.min.mjs"() {
    ...
    qn = ((t) => typeof __require < "u" ? __require : typeof Proxy < "u" ? new Proxy(t, { get: (e, r) => (typeof __require < "u" ? __require : e)[r] }) : t)(function(t) {
    ...
    Ef = (t, e, r, n) => {
      if (e && typeof e == "object" || typeof e == "function") for (let o of Cf(e)) !Af.call(t, o) && o !== r && Fn(t, o, { get: () => e[o], enumerable: !(n = If(e, o)) || n.enumerable });
      return t;
    };
    er = (t) => Ef(Fn({}, "__esModule", { value: true }), t);
    Kn = V(() => {
      "use strict";
    ...
    jn = V(() => {
      "use strict";
      Ua();
      Na = "warning", De = { wasm: {}, webgl: {}, webgpu: {}, versions: { common: Ra }, set logLevel(t) {
        if (t !== void 0) {
      ...
      Object.defineProperty(De, "logLevel", { enumerable: true });
    });
    Va = V(() => {
      "use strict";
      jn();
      ...
      La = (t, e) => {
        ...
        if (n != null) {
          ...
          for (let _ = 0; _ < i; _++) for (let S = 0; S < o; S++) {
            let x = (t.data[m++] - c[0]) * d[0], v = (t.data[g++] - c[1]) * d[1], T = (t.data[y++] - c[2]) * d[2], I = b === -1 ? 255 : (t.data[b++] - c[3]) * d[3];
            n.fillStyle = "rgba(" + x + "," + v + "," + T + "," + I + ")", n.fillRect(S, _, 1, 1);
          }
        ...
        if (r != null) {
          ...
          let g = 4, y = 0, b = 1, _ = 2, S = 3, x = 0, v = m, T = m * 2, I = -1;
          u === "RGBA" ? (x = 0, v = m, T = m * 2, I = m * 3) : u === "RGB" ? (x = 0, v = m, T = m * 2) : u === "RBG" && (x = 0, T = m, v = m * 2), n = r.createImageData(o, i);
          for (let E = 0; E < i * o; y += g, b += g, _ += g, S += g, E++) n.data[y] = (t.data[x++] - p[0]) * c[0], n.data[b] = (t.data[v++] - p[1]) * c[1], n.data[_] = (t.data[T++] - p[2]) * c[2], n.data[S] = I === -1 ? 255 : (t.data[I++] - p[3]) * c[3];
        } else throw new Error("Can not access image data");
        return n;
      };
    });
    Za = V(() => {
      ...
      Zn = (t, e) => {
        ...
        let u = e.format !== void 0 ? e.format : "RGBA", d = e.tensorFormat !== void 0 && e.tensorFormat !== void 0 ? e.tensorFormat : "RGB", c = r * n, p = d === "RGBA" ? new Float32Array(c * 4) : new Float32Array(c * 3), m = 4, g = 0, y = 1, b = 2, _ = 3, S = 0, x = c, v = c * 2, T = -1;
        u === "RGB" && (m = 3, g = 0, y = 1, b = 2, _ = -1), d === "RGBA" ? T = c * 3 : d === "RBG" ? (S = 0, v = c, x = c * 2) : d === "BGR" && (v = 0, x = c, S = c * 2);
        for (let E = 0; E < c; E++, g += m, b += m, y += m, _ += m) p[S++] = (t[g] + a[0]) / i[0], p[x++] = (t[y] + a[1]) / i[1], p[v++] = (t[b] + a[2]) / i[2], T !== -1 && _ !== -1 && (p[T++] = (t[_] + a[3]) / i[3]);
        ...
        return new Be({ location: "texture", type: "float32", texture: t, dims: a, download: o, dispose: i });
      }, qa = (t, e) => {
    ...
    Ya = V(() => {
      ...
      Ot = /* @__PURE__ */ new Map([["float32", Float32Array], ["uint8", Uint8Array], ["int8", Int8Array], ["uint16", Uint16Array], ["int16", Int16Array], ["int32", Int32Array], ["bool", Uint8Array], ["float64", Float64Array], ["uint32", Uint32Array], ["int4", Uint8Array], ["uint4", Uint8Array]]), tr = /* @__PURE__ */ new Map([[Float32Array, "float32"], [Uint8Array, "uint8"], [Int8Array, "int8"], [Uint16Array, "uint16"], [Int16Array, "int16"], [Int32Array, "int32"], [Float64Array, "float64"], [Uint32Array, "uint32"]]), Qa = false, Xa = () => {
        if (!Qa) {
          ...
          t && (Ot.set("int64", BigInt64Array), tr.set(BigInt64Array, "int64")), e && (Ot.set("uint64", BigUint64Array), tr.set(BigUint64Array, "uint64")), n ? (Ot.set("float16", r), tr.set(r, "float16")) : Ot.set("float16", Uint16Array);
        }
      };
    });
    ts = V(() => {
    ...
    Xn = V(() => {
      ...
      jn();
      Cr = (t, e) => {
        (typeof De.trace > "u" ? !De.wasm.trace : !De.trace) || console.timeStamp(`${t}::ORT::${e}`);
      }, rs = (t, e) => {
        ...
        (typeof De.trace > "u" ? !De.wasm.trace : !De.trace) || rs("BEGIN", t);
      }, Re = (t) => {
        (typeof De.trace > "u" ? !De.wasm.trace : !De.trace) || rs("END", t);
      }, _t = (t) => {
        (typeof De.trace > "u" ? !De.wasm.trace : !De.trace) || console.time(`ORT::${t}`);
      }, wt = (t) => {
        (typeof De.trace > "u" ? !De.wasm.trace : !De.trace) || console.timeEnd(`ORT::${t}`);
      };
    });
    ns = V(() => {
      "use strict";
      ...
      Ar = class t {
        ...
        static async create(e, r, n, o) {
          ...
          let [u, d] = await Ba(a), c = await u.createInferenceSessionHandler(i, d);
    ...
    Yn = {};
    Wt(Yn, { InferenceSession: () => Pf, TRACE: () => Cr, TRACE_EVENT_BEGIN: () => _t, TRACE_EVENT_END: () => wt, TRACE_FUNC_BEGIN: () => Ve, TRACE_FUNC_END: () => Re, Tensor: () => je, env: () => _e, registerBackend: () => Pt });
    Le = V(() => {
      "use strict";
      Ma();
      Va();
    ...
    ms = V(() => {
      ...
      $t();
      kr();
      ls = "ort-wasm-proxy-worker", cs = globalThis.self?.name === ls;
      cs && (self.onmessage = (t) => {
      ...
      Of = cs ? null : (t) => new Worker(t ?? We, { type: "module", name: ls });
    });
    hs = {};
    Wt(hs, { default: () => Df });
    gs = V(() => {
      "use strict";
      Df = fs, zf = globalThis.self?.name?.startsWith("em-pthread");
      zf && fs();
    });
    kr = V(() => {
      "use strict";
      Er();
      _s = typeof location > "u" ? void 0 : location.origin, to = import.meta.url > "file:" && import.meta.url < "file;", Bf = () => {
        if (true) {
          if (to) {
            let t = URL;
            return new URL(new t("ort.bundle.min.mjs", import.meta.url).href, _s).href;
          }
        ...
        try {
          let r = e ?? We;
          return (r ? new URL(t, r) : new URL(t)).origin === _s;
        } catch {
          return false;
        }
      }, Mf = (t, e) => {
      ...
      }, Rf = (t, e) => `${e ?? "./"}${t}`, $s = async (t) => {
        let r = await (await fetch(t, { credentials: "same-origin" })).blob();
        return URL.createObjectURL(r);
      }, Uf = async (t) => (await import(
        /*webpackIgnore:true*/
        /*@vite-ignore*/
        t
      )).default, bs = (ms(), er(ps)).default, vs = async () => {
        if (!We) throw new Error("Failed to load proxy worker: cannot determine the script source URL.");
        if (eo(We)) return [void 0, bs()];
        let t = await $s(We);
        return [t, bs(t)];
      }, ys = (gs(), er(hs)).default, xs = async (t, e, r, n) => {
        let o = ys && !(t || e);
        if (o) if (We) o = eo(We) || n && !r;
        else if (n && !r) o = true;
        else throw new Error("cannot determine the script source URL.");
        if (o) return [void 0, ys];
        {
          let i = "ort-wasm-simd-threaded.jsep.mjs", a = t ?? Mf(i, e), u = r && a && !eo(a, e), d = u ? await $s(a) : a ?? Rf(i, e);
          return [u ? d : void 0, await Uf(d)];
        }
      };
    });
    $t = V(() => {
      ...
      no = false, Nr = false, Ss = false, Nf = () => {
        ...
        if (Ss) throw new Error("previous call to 'initializeWebAssembly()' failed.");
        Nr = true;
        let e = t.initTimeout, r = t.numThreads;
        if (t.simd !== false) {
          if (t.simd === "relaxed") {
            if (!Lf()) throw new Error("Relaxed WebAssembly SIMD is not supported in the current environment.");
        ...
        let o = t.wasmPaths, i = typeof o == "string" ? o : void 0, a = o?.mjs, u = a?.href ?? a, d = o?.wasm, c = d?.href ?? d, p = t.wasmBinary, [m, g] = await xs(u, i, r > 1, !!p || !!c), y = false, b = [];
        if (e > 0 && b.push(new Promise((_) => {
          ...
          let x = { numThreads: r };
          if (p) x.wasmBinary = p, x.locateFile = (v) => v;
          else if (c || i) x.locateFile = (v) => c ?? i + v;
          else if (u && u.indexOf("blob:") !== 0) x.locateFile = (v) => new URL(v, u).href;
          else if (m) {
            let v = ws();
            v && (x.locateFile = (T) => v + T);
          }
          g(x).then((v) => {
            Nr = false, no = true, ro = v, _(), m && URL.revokeObjectURL(m);
          }, (v) => {
            Nr = false, Ss = true, S(v);
          });
    ...
    As = V(() => {
      ...
      Wf = (t) => {
        ...
        Hf(o);
        try {
          let i = Wf(o.graphOptimizationLevel ?? "all"), a = Gf(o.executionMode ?? "sequential"), u = typeof o.logId == "string" ? Ge(o.logId, n) : 0, d = o.logSeverityLevel ?? 2;
          ...
          if (r = e._OrtCreateSessionOptions(i, !!o.enableCpuMemArena, !!o.enableMemPattern, a, !!o.enableProfiling, 0, u, d, c, p), r === 0 && me("Can't create session options."), o.executionProviders && await Ff(r, o, n), o.enableGraphCapture !== void 0) {
    ...
    io = V(() => {
      ...
      ir = async (t) => {
        if (typeof t == "string") if (false) try {
          let { readFile: e } = qn("node:fs/promises");
          return new Uint8Array(await e(t));
        } catch (e) {
          if (e.code === "ERR_FS_FILE_TOO_LARGE") {
            let { createReadStream: r } = qn("node:fs"), n = r(t), o = [];
    ...
    nt = V(() => {
      ...
      ee();
      qf = ["V", "I", "W", "E", "F"], Kf = (t, e) => {
        console.log(`[${qf[t]},${(/* @__PURE__ */ new Date()).toISOString()}]${e}`);
      }, Gr = (t, e) => {
        Es = t, ks = e;
      }, jf = (t, e) => {
        let r = or(t), n = or(Es);
        r >= n && Kf(r, typeof e == "function" ? e() : e);
      }, se = (...t) => {
        ks && jf(...t);
      };
    });
    te = V(() => {
      ...
      }, Ps = -34028234663852886e22, Os = 34028234663852886e22;
    });
    so = V(() => {
      "use strict";
      ee();
    ...
    Us = V(() => {
      ...
      ee();
      nt();
      zs = /* @__PURE__ */ new Map([["float32", 32], ["float16", 16], ["int32", 32], ["uint32", 32], ["int64", 64], ["uint64", 64], ["int8", 8], ["uint8", 8], ["int4", 4], ["uint4", 4]]), Zf = (t, e) => {
        if (e === "int32") return t;
        let r = zs.get(e);
      ...
      }, Qf = 1, Ds = () => Qf++, Xf = /* @__PURE__ */ new Map([["int8", "int32"], ["uint8", "int32"], ["uint32", "int32"], ["int64", "int32"]]), Ms = (t, e) => {
        let r = zs.get(t);
        ...
        async read(e) {
          if (this.fallbackDataType) {
            let r = await this.mlContext.readTensor(this.mlTensor), n = Bs(new Uint8Array(r), this.dataType);
            if (e) {
        ...
        async ensureTensor(e, r, n, o) {
          ...
          if (!a?.input.dataTypes.includes(r)) {
            if (u = Xf.get(r), !u || a?.input.dataTypes.includes(u)) throw new Error(`WebNN backend does not support data type: ${r}`);
          ...
          if (this.wrapper) {
            ...
            if (o) {
              if (this.wrapper.byteLength !== Ms(r, n)) throw new Error("Unable to copy data to tensor with different size.");
        ...
        upload(e) {
          let r = e;
          if (this.wrapper) {
            if (this.wrapper.fallbackType) if (this.wrapper.fallbackType === "int32") r = Zf(e, this.wrapper.type), this.wrapper.setIsDataConverted(true);
        ...
        async download(e) {
          if (this.activeUpload) {
            let r = this.wrapper?.isDataConverted ? Bs(this.activeUpload, this.wrapper?.type) : this.activeUpload;
            if (e) {
        ...
        registerTensor(e, r, n, o) {
          let i = this.getMLContext(e), a = Ds(), u = new qr({ sessionId: e, context: i, tensor: r, dataType: n, shape: o });
    ...
    Ns = V(() => {
      ...
      Us();
      nt();
      jr = /* @__PURE__ */ new Map([[1, "float32"], [10, "float16"], [6, "int32"], [12, "uint32"], [7, "int64"], [13, "uint64"], [22, "int4"], [21, "uint4"], [3, "int8"], [2, "uint8"], [9, "uint8"]]), Yf = (t, e) => {
        if (t === e) return true;
        ...
        async createMLContext(e) {
          ...
          let r = this.mlContextCache.findIndex((n) => Yf(n.options, e));
        ...
        isGraphInputOutputTypeSupported(e, r, n = true) {
          let o = jr.get(vt(r)), i = this.mlOpSupportLimitsBySessionId.get(e);
    ...
    Hs = V(() => {
      ...
      Vs = /* @__PURE__ */ new Map([[64, 250], [128, 200], [256, 200], [512, 200], [2048, 230], [4096, 200], [8192, 50], [16384, 50], [32768, 50], [65536, 50], [131072, 50], [262144, 50], [524288, 50], [1048576, 50], [2097152, 30], [4194304, 20], [8388608, 10], [12582912, 10], [16777216, 10], [26214400, 15], [33554432, 22], [44236800, 2], [58982400, 6], [67108864, 6], [134217728, 6], [167772160, 6]]), lo = [], co = (t) => Math.ceil(Number(t) / 16) * 16, Jf = (t) => {
        ...
        constructor(e) {
          ...
          for (let [r] of Vs) lo.push(r), this.freeBuffers.set(r, []), this.freeUniformBuffers.set(r, []);
          this.sessionCount = 0;
        }
        upload(e, r) {
        ...
        create(e, r = GPUBufferUsage.STORAGE | GPUBufferUsage.COPY_SRC | GPUBufferUsage.COPY_DST) {
          let n = Jf(e), o, i = (r & GPUBufferUsage.STORAGE) === GPUBufferUsage.STORAGE, a = (r & GPUBufferUsage.UNIFORM) === GPUBufferUsage.UNIFORM;
          if (i || a) {
  ...
  fn o2i_${t}(offset: u32) -> ${g.indices} {
    ...
    ${v}
    return indices;
  }`, I = (M) => (b.offsetToIndices = true, a < 2 ? M : `o2i_${t}(${M})`), E = [];
        if (a >= 2) for (let M = a - 1; M >= 0; M--) E.push(`${j(x, M, a)} * (indices[${M}])`);
        let A = a < 2 ? "" : `
  fn i2o_${t}(indices: ${g.indices}) -> u32 {
    return ${E.join("+")};
  }`, D = (M) => (b.indicesToOffset = true, a < 2 ? M : `i2o_${t}(${M})`), w = (...M) => a === 0 ? "0u" : `${g.indices}(${M.map(y).join(",")})`, U = (M, G) => a < 2 ? `${M}` : `${j(M, G, a)}`, N = (M, G, be) => a < 2 ? `${M}=${be};` : `${j(M, G, a)}=${be};`, F = {}, q = (M, G) => {
          b.broadcastedIndicesToOffset = true;
          let be = `${G.name}broadcastedIndicesTo${t}Offset`;
          if (be in F) return `${be}(${M})`;
          let ke = [];
          for (let ve = a - 1; ve >= 0; ve--) {
            let Oe = G.indicesGet("outputIndices", ve + G.rank - a);
            ke.push(`${U(x, ve)} * (${Oe} % ${U(S, ve)})`);
          }
  ...
  fn get_${t}(${M}) -> ${p} {
    return get_${t}ByIndices(${w(G)});
          ...
          let G = M.map(y).join(",");
          return a === 0 ? z("0u") : a === 1 ? z(G[0]) : (b.get = true, b.getByIndices = true, b.indicesToOffset = true, `get_${t}(${G})`);
        }, Z = (M) => a < 2 ? z(M) : (b.getByIndices = true, b.indicesToOffset = true, `get_${t}ByIndices(${M})`), ne = a < 2 ? "" : `
  ...
  fn set_${t}(${M}, value: ${p}) {
    set_${t}ByIndices(${w(G)}, value);
        ...
        return { impl: () => {
          let M = [], G = false;
          return b.offsetToIndices && (M.push(T), G = true), b.indicesToOffset && (M.push(A), G = true), b.broadcastedIndicesToOffset && (Object.values(F).forEach((be) => M.push(be)), G = true), b.set && (M.push(ie), G = true), b.setByIndices && (M.push(ne), G = true), b.get && (M.push(Q), G = true), b.getByIndices && (M.push(L), G = true), !i && G && M.unshift(`const ${S} = ${g.indices}(${r.join(",")});`, `const ${x} = ${g.indices}(${k.computeStrides(r).join(",")});`), M.join(`
`);
        }, type: g, offsetToIndices: I, indicesToOffset: D, broadcastedIndicesToOffset: q, indices: w, indicesGet: U, indicesSet: N, set: (...M) => {
          ...
          return a === 0 ? Y("0u", G) : a === 1 ? Y(be[0], G) : (b.set = true, b.setByIndices = true, b.indicesToOffset = true, `set_${t}(${be}, ${G})`);
        }, setByOffset: Y, setByIndices: (M, G) => a < 2 ? Y(M, G) : (b.setByIndices = true, b.indicesToOffset = true, `set_${t}ByIndices(${M}, ${G});`), get: X, getByOffset: z, getByIndices: Z, usage: n, name: t, strides: x, shape: S, rank: a };
      }, O = (t, e, r, n = 1) => Xr(t, e, r, "input", n), R = (t, e, r, n = 1) => Xr(t, e, r, "output", n), Fs = (t, e, r) => Xr(t, e, r, "atomicOutput", 1), Yr = (t, e, r, n = 1) => Xr(t, e, r, "internal", n), ho = class {
        constructor(e, r) {
...
`);
    ...
    pt = V(() => {
      ...
      }, Ks = (t, e) => e.length !== 0 ? e : [...new Array(t).keys()].reverse(), rh = (t, e) => k.sortBasedOnPerm(t, Ks(t.length, e)), nh = (t, e, r, n) => {
    ...
    var a: ${r.type.indices};`;
        ...
        let r = t.dataType, n = t.dims.length, o = Ks(n, e), i = rh(t.dims, o), a = t.dims, u = i, d = n < 2 || ih(o, t.dims), c;
        if (d) return c = (_) => {
          let S = O("input", r, a, 4), x = R("output", r, u, 4);
          return `
  ...
  ${_.mainStart()}
    ...
    output[global_idx] = input[global_idx];
        ...
        let { newShape: p, newPerm: m } = oh(t.dims, o), g = k.areEqual(m, [2, 3, 1]), y = k.areEqual(m, [3, 1, 2]);
        if (p.length === 2 || g || y) {
          a = g ? [p[0], p[1] * p[2]] : y ? [p[0] * p[1], p[2]] : p, u = [a[1], a[0]];
          let _ = 16;
          return c = (S) => {
            let x = O("a", r, a.length), v = R("output", r, u.length);
            return `
  ...
  ${S.mainStart([_, _, 1])}
    ...
    if (output_row < uniforms.output_shape[0] && output_col < uniforms.output_shape[1]) {
      ${v.setByIndices(`${v.type.indices}(output_row, output_col)`, "tile[local_id.x][local_id.y]")}
        ...
        return c = (_) => {
          let S = O("a", r, a.length), x = R("output", r, u.length);
          return `
  ${_.registerUniform("output_size", "u32").declareVariables(S, x)}
  ...
  ${_.mainStart()}
    ...
    ${x.setByOffset("global_idx", S.getByIndices("aIndices"))}
        ...
        th(t.inputs, e.perm), t.compute(ze(t.inputs[0], e.perm));
      }, Zs = (t) => J({ perm: t.perm });
    });
    au = V(() => {
      "use strict";
      ...
      Jr();
      pt();
      ah = { max: "select(bestValue, candidate, candidate > bestValue)", min: "select(bestValue, candidate, candidate < bestValue)", mean: "bestValue + candidate", sum: "bestValue + candidate", prod: "bestValue * candidate", sumSquare: "bestValue + candidate * candidate", logSumExp: "bestValue + exp(candidate)", l1: "bestValue + abs(candidate)", l2: "bestValue + candidate * candidate", logSum: "bestValue + candidate" }, sh = { max: "select(bestValue, candidate, candidate > bestValue)", min: "select(bestValue, candidate, candidate < bestValue)", mean: "bestValue + candidate", sum: "bestValue + candidate", prod: "bestValue * candidate", sumSquare: "bestValue + candidate", logSumExp: "bestValue + candidate", l1: "bestValue + candidate", l2: "bestValue + candidate", logSum: "bestValue + candidate" }, uh = { max: "_A[offset]", min: "_A[offset]", mean: "0", sum: "0", prod: "1", sumSquare: "0", logSumExp: "0", l1: "0", l2: "0", logSum: "0" }, dh = { max: "bestValue", min: "bestValue", sum: "bestValue", prod: "bestValue", sumSquare: "bestValue", logSumExp: "log(bestValue)", l1: "bestValue", l2: "sqrt(bestValue)", logSum: "log(bestValue)" }, lh = (t, e) => {
        let r = [];
        ...
        let u = r[0].dims, d = k.size(i), c = k.size(a), p = O("_A", r[0].dataType, u), m = R("output", o, i), g = 64;
        d === 1 && (g = 256);
        let y = `
       ...
       `, b = (_) => `
        ...
        let a = k.normalizeAxes(i, t.inputs[0].dims.length), u = a, d = t.inputs[0], c = fh(u, t.inputs[0].dims.length);
        c.length > 0 && (d = t.compute(ze(t.inputs[0], c), { inputs: [0], outputs: [-1] })[0], u = lh(u.length, d.dims.length));
        let [p, m] = ch(d.dims, u), g = p;
        o.keepDims && (g = ph(p, a)), t.compute(hh(e, o.cacheKey, [d], n, t.inputs[0].dataType, g, m), { inputs: [d] });
      }, Qs = (t, e) => {
    ...
    Jr = V(() => {
      ...
      at = (t) => {
      ...
      }, gh = (t) => ["", "", `var value = ${t.getByIndices("input_indices")};`, ""], en = (t, e, r, n, o, i, a = false, u = false) => {
        ...
        return { name: t, shaderCache: e, getShaderSource: (S) => {
          let x = [], v = O("_A", r[0].dataType, p), T = R("output", i, y), I = n(v, T, m), E = I[2];
          for (let A = 0, D = 0; A < p; A++) g || m.indexOf(A) >= 0 ? (a && D++, E = `for(var j${A}: u32 = 0; j${A} < ${c[A]}; j${A}++) {
                  ${I[2].includes("last_index") ? `let last_index = j${A};` : ""}
                  ${v.indicesSet("input_indices", A, `j${A}`)}
                  ${E}
                }`) : (x.push(`${v.indicesSet("input_indices", A, T.indicesGet("output_indices", D))};`), D++);
          return `
...
`)}
        ...
        t.compute(en(e, { hint: i.cacheKey, inputDependencies: ["rank"] }, [o[0]], i.noopWithEmptyAxes && i.axes.length === 0 ? gh : n, i.axes, o[0].dataType, i.keepDims, i.noopWithEmptyAxes), { inputs: [0] });
      }, bh = (t, e) => {
...
`)}`, `var value = ${n.getByIndices("input_indices")};`, `value = min(value, ${n.getByIndices("input_indices")});`, ""];
        ...
        ut(t.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? vh(t, e) : Qs(t, e);
      }, uu = (t, e) => {
        ut(t.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? yh(t, e) : Xs(t, e);
      }, du = (t, e) => {
        ut(t.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? _h(t, e) : Ys(t, e);
      }, lu = (t, e) => {
        ut(t.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? wh(t, e) : Js(t, e);
      }, cu = (t, e) => {
        ...
        ut(t.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? Th(t, e) : nu(t, e);
      }, hu = (t, e) => {
        ut(t.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? Ih(t, e) : ou(t, e);
      }, gu = (t, e) => {
        ut(t.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? bh(t, e) : iu(t, e);
      };
    });
    wu = V(() => {
      "use strict";
...
var best_index : i32 = 0;`, `if (${n.getByIndices("input_indices")} ${e.selectLastIndex > 0 ? ">=" : ">"} value) {
    ...
    `, Ah = (t, e, r, n, o, i, a, u) => {
        ...
        let S = (x) => {
          let v = R("x", t.dataType, t.dims, d), T = [v], I = a ? O("seq_lens", a.dataType, a.dims) : void 0;
          I && T.push(I);
          let E = u ? O("total_sequence_length_input", u.dataType, u.dims) : void 0;
          E && T.push(E);
          let A = Ae(t.dataType), D = [{ name: "batch_size", type: "u32" }, { name: "num_heads", type: "u32" }, { name: "past_sequence_length", type: "u32" }, { name: "sequence_length", type: "u32" }, { name: "total_sequence_length", type: "u32" }, { name: "elements_per_thread", type: "u32" }];
          return `
  ...
  ${x.mainStart([c, 1, 1])}
    ...
    if (sum == 0) {
      ...
      ${a ? `
        ...
        let D = [{ dims: p, dataType: e.dataType, gpuDataType: 0 }];
        m && D.push({ dims: y, dataType: e.dataType, gpuDataType: 0 });
        let w = (U) => {
          let N = O("q", e.dataType, e.dims, S), F = O("key", r.dataType, r.dims, S), q = [N, F];
          if (E) {
            let ne = O("past_key", n.dataType, n.dims, S);
            q.push(ne);
          }
          o && q.push(O("attention_bias", o.dataType, o.dims));
          let Y = u ? O("seq_lens", u.dataType, u.dims) : void 0;
          Y && q.push(Y);
          let z = d ? O("total_sequence_length_input", d.dataType, d.dims) : void 0;
          z && q.push(z);
          let L = R("output", e.dataType, p), Q = [L];
          m && Q.push(R("present_key", e.dataType, y, S));
          let X = Ae(1, S), Z = [{ name: "M", type: "u32" }, { name: "K", type: "u32" }, { name: "N", type: "u32" }, { name: "num_heads", type: "u32" }, { name: "head_size", type: "u32" }, { name: "alpha", type: "f32" }, { name: "past_sequence_length", type: "u32" }, { name: "kv_sequence_length", type: "u32" }, { name: "n_reps", type: "u32" }];
          return `
  const TILE_SIZE = ${v}u;
  ...
  ${U.mainStart([v, v, 1])}
    ...
    if (global_id.y < uniforms.M && global_id.x < total_sequence_length) {
      ...
      var sum: f32 = ${(() => {
        ...
        return { name: "AttentionProbs", shaderCache: { hint: `${S};${o !== void 0};${n !== void 0};${t}`, inputDependencies: A }, getRunData: () => ({ outputs: D, dispatchGroup: T, programUniforms: I }), getShaderSource: w };
      }, kh = (t, e, r, n, o, i, a = void 0, u = void 0) => {
        let d = i + o.kvSequenceLength, c = o.nReps ? o.nReps : 1, p = o.vHiddenSize * c, m = t > 1 && n, g = o.kvNumHeads ? o.kvNumHeads : o.numHeads, y = m ? [o.batchSize, g, d, o.headSize] : void 0, b = [o.batchSize, o.sequenceLength, p], _ = 12, S = { x: Math.ceil(o.vHeadSize / _), y: Math.ceil(o.sequenceLength / _), z: o.batchSize * o.numHeads }, x = [{ type: 12, data: o.sequenceLength }, { type: 12, data: d }, { type: 12, data: o.vHeadSize }, { type: 12, data: o.numHeads }, { type: 12, data: o.headSize }, { type: 12, data: p }, { type: 12, data: i }, { type: 12, data: o.kvSequenceLength }, { type: 12, data: c }], v = m && n && k.size(n.dims) > 0, T = ["type", "type"];
        v && T.push("type"), a && T.push("type"), u && T.push("type");
        let I = [{ dims: b, dataType: e.dataType, gpuDataType: 0 }];
        m && I.push({ dims: y, dataType: e.dataType, gpuDataType: 0 });
        let E = (A) => {
          let D = O("probs", e.dataType, e.dims), w = O("v", r.dataType, r.dims), U = [D, w];
          v && U.push(O("past_value", n.dataType, n.dims));
          let N = a ? O("seq_lens", a.dataType, a.dims) : void 0;
          a && U.push(N);
          let F = u ? O("total_sequence_length_input", u.dataType, u.dims) : void 0;
          u && U.push(F);
          let Y = [R("output", e.dataType, b)];
          m && Y.push(R("present_value", e.dataType, y));
  ...
  ${A.mainStart([_, _, 1])}
   ...
   if (m < uniforms.M && n < uniforms.N) {
     ...
     output[outputIdx] = value;
        ...
        let g = Math.min(t.outputCount, 1 + (a ? 1 : 0) + (u ? 1 : 0)), y = g > 1 ? a : void 0, b = g > 1 ? u : void 0, _ = g > 1 ? c.pastSequenceLength : 0, S = _ + c.kvSequenceLength, x = d && k.size(d.dims) > 0 ? d : void 0, v = [e, r];
        y && k.size(y.dims) > 0 && v.push(y), x && v.push(x), p && v.push(p), m && v.push(m);
        let T = t.compute(Eh(g, e, r, y, x, c, _, p, m), { inputs: v, outputs: g > 1 ? [-1, 1] : [-1] })[0];
        t.compute(Ah(T, c.batchSize, c.numHeads, _, c.sequenceLength, S, p, m), { inputs: p && m ? [T, p, m] : [T], outputs: [] });
        let I = [T, n];
        b && k.size(b.dims) > 0 && I.push(b), p && I.push(p), m && I.push(m), t.compute(kh(g, T, n, b, c, _, p, m), { inputs: I, outputs: g > 1 ? [0, 2] : [0] });
      }, Ph = (t, e) => {
        let r = [e.batchSize, e.numHeads, e.sequenceLength, e.headSize], n = e.sequenceLength, o = e.inputHiddenSize, i = e.headSize, a = 12, u = { x: Math.ceil(e.headSize / a), y: Math.ceil(e.sequenceLength / a), z: e.batchSize * e.numHeads }, d = [t.inputs[0], t.inputs[1], t.inputs[2]], c = [{ type: 12, data: n }, { type: 12, data: o }, { type: 12, data: i }, { type: 12, data: e.numHeads }, { type: 12, data: e.headSize }, { type: 12, data: e.hiddenSize }, { type: 12, data: e.hiddenSize + e.hiddenSize + e.vHiddenSize }], p = (m) => {
          let g = R("output_q", d[0].dataType, r), y = R("output_k", d[0].dataType, r), b = R("output_v", d[0].dataType, r), _ = O("input", d[0].dataType, d[0].dims), S = O("weight", d[1].dataType, d[1].dims), x = O("bias", d[2].dataType, d[2].dims), v = _.type.storage, T = [{ name: "M", type: "u32" }, { name: "K", type: "u32" }, { name: "N", type: "u32" }, { name: "num_heads", type: "u32" }, { name: "head_size", type: "u32" }, { name: "hidden_size", type: "u32" }, { name: "ldb", type: "u32" }];
          return `
  const TILE_SIZE = ${a}u;
  ...
  ${m.mainStart([a, a, 1])}
    ...
    if (m < uniforms.M && n < uniforms.N) {
      ...
      output_v[outputIdx] = valueV;
        ...
        let r = Ch(t.inputs, e), [n, o, i] = Ph(t, r);
    ...
    xu = V(() => {
      ...
      Oh = (t, e) => {
        ...
        let { epsilon: r, spatial: n, format: o } = e, i = t[0].dims, a = n ? fe(i[i.length - 1]) : 1, u = o === "NHWC" && i.length > 1 ? a : 1, d = k.size(i) / a, c = n, p = c ? i.length : i, m = O("x", t[0].dataType, t[0].dims, a), g = O("scale", t[1].dataType, t[1].dims, u), y = O("bias", t[2].dataType, t[2].dims, u), b = O("inputMean", t[3].dataType, t[3].dims, u), _ = O("inputVar", t[4].dataType, t[4].dims, u), S = R("y", t[0].dataType, p, a), x = () => {
          let T = "";
  ...
  ${T.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
    ...
    ${S.setByOffset("global_idx", "value")}
        ...
        return { name: "BatchNormalization", shaderCache: { hint: `${e.epsilon}_${e.format}_${n}_${a}`, inputDependencies: c ? ["rank", "type", "type", "type", "type"] : void 0 }, getShaderSource: v, getRunData: () => ({ outputs: [{ dims: t[0].dims, dataType: t[0].dataType }], dispatchGroup: { x: Math.ceil(d / 64) }, programUniforms: c ? [{ type: 12, data: d }, ...W(i)] : [{ type: 12, data: d }] }) };
      }, zh = (t) => J(t), vu = (t, e) => {
        let { inputs: r, outputCount: n } = t, o = zh({ ...e, outputCount: n });
        if (_e.webgpu.validateInputContent && Oh(r, o), e.trainingMode) throw new Error("BatchNormalization trainingMode is not supported yet.");
        t.compute(Dh(r, o));
      };
    });
    Tu = V(() => {
      ...
      Bh = (t) => {
        ...
        let e = t[0].dims, r = t[0].dims[2], n = k.size(e) / 4, o = t[0].dataType, i = O("input", o, e, 4), a = O("bias", o, [r], 4), u = O("residual", o, e, 4), d = R("output", o, e, 4);
  ...
  ${p.mainStart()}
    ...
    ${d.setByOffset("global_idx", "value")}
        ...
        Bh(t.inputs), t.compute(Mh(t.inputs));
      };
    });
    nn = V(() => {
      "use strict";
  ...
  ${t.mainStart()}
    ...
    ${p.setByOffset("global_idx", d)}
        ...
        return a && d.push(...a), { name: e, shaderCache: { hint: o, inputDependencies: ["type"] }, getShaderSource: (c) => Rh(c, k.size(t.dims), t.dataType, i, r, n, u), getRunData: (c) => ({ outputs: [{ dims: t.dims, dataType: i }], dispatchGroup: { x: Math.ceil(k.size(c[0].dims) / 64 / 4) }, programUniforms: d }) };
      }, Iu = (t) => {
        ...
        let r = e || Uh(t.inputs), n = Ae(t.inputs[0].dataType);
...
fn erf_vf32(v: vec4<${t}>) -> vec4<${t}> {
  ...
  return sign(v) * (1.0 - ((((r5 * x + r4) * x + r3) * x + r2) * x + r1) * x * exp(-absv * absv));
      ...
      }, nd = (t) => `sign(${t}) * (1 - exp(-2 * abs(${t}))) / (1 + exp(-2 * abs(${t})))`, od = (t) => {
        t.compute(he(t.inputs[0], "Tanh", nd));
      }, $o = (t = "f32") => `
...
`, vo = (t) => `(fast_gelu_a + fast_gelu_a * tanh_v(${t} * (fast_gelu_c * ${t} * ${t} + fast_gelu_b))) * ${t}`, id = (t) => {
        let e = Ae(t.inputs[0].dataType);
        t.compute(he(t.inputs[0], "FastGelu", vo, $o(e), void 0, t.inputs[0].dataType));
      }, ad = (t, e) => {
        let r = Ae(t.inputs[0].dataType);
...
`, Vh = (t) => `quick_gelu_impl(${t})`, ud = (t, e) => {
        let r = Ae(t.inputs[0].dataType);
        t.compute(he(t.inputs[0], "QuickGelu", Vh, Nh(r, e.alpha), e.cacheKey, t.inputs[0].dataType));
      };
    });
    cd = V(() => {
      "use strict";
      ...
      Lh = (t) => {
        ...
        e[2] = e[2] / 2;
        let r = O("input", t[0].dataType, t[0].dims, 4), n = O("bias", t[0].dataType, [t[0].dims[2]], 4), o = R("output", t[0].dataType, e, 4), i = k.size(e) / 4, a = we(t[0].dataType);
  ...
  ${d.mainStart()}
    ...
    ${o.setByOffset("global_idx", "valueLeft * geluRight")}
        ...
        Lh(t.inputs), t.compute(Wh(t.inputs));
      };
    });
    vd = V(() => {
      "use strict";
      ...
      te();
      oe();
      Gh = (t, e, r, n, o, i, a, u, d, c, p, m) => {
        let g, y;
        typeof u == "string" ? g = y = (v, T) => `${u}((${v}),(${T}))` : typeof u == "function" ? g = y = u : (g = u.scalar, y = u.vector);
        let b = R("outputData", p, n.length, 4), _ = O("aData", d, e.length, 4), S = O("bData", c, r.length, 4), x;
        if (o) if (i) {
          let v = k.size(e) === 1, T = k.size(r) === 1, I = e.length > 0 && e[e.length - 1] % 4 === 0, E = r.length > 0 && r[r.length - 1] % 4 === 0;
          v || T ? x = b.setByOffset("global_idx", y(v ? `${_.type.value}(${_.getByOffset("0")}.x)` : _.getByOffset("global_idx"), T ? `${S.type.value}(${S.getByOffset("0")}.x)` : S.getByOffset("global_idx"))) : x = `
        ...
        if (c) {
          ...
          let S = k.size(u) === 1, x = k.size(d) === 1, v = u.length > 0 && u[u.length - 1] % 4 === 0, T = d.length > 0 && d[d.length - 1] % 4 === 0;
          b.push(S), b.push(x), b.push(v), b.push(T);
          let I = 1;
          for (let E = 1; E < p.length; E++) {
            let A = u[u.length - E], D = d[d.length - E];
            if (A === D) I *= A;
            else break;
          }
          I % 4 === 0 ? (y = true, g = true) : (S || x || v || T) && (g = true);
        } else g = true;
        return b.push(g), { name: t, shaderCache: { hint: e + b.map((_) => _.toString()).join("_"), inputDependencies: ["rank", "rank"] }, getShaderSource: (_) => Gh(_, u, d, p, g, c, y, o, r.dataType, n.dataType, a, i), getRunData: () => ({ outputs: [{ dims: p, dataType: a }], dispatchGroup: { x: Math.ceil(m / 64 / 4) }, programUniforms: [{ type: 12, data: Math.ceil(k.size(p) / 4) }, ...W(u, d, p)] }) };
      }, dt = (t, e, r, n, o, i) => {
        t.compute(Hh(e, o ?? "", t.inputs[0], t.inputs[1], r, n, i));
      }, pd = (t) => {
        dt(t, "Add", (e, r) => `${e}+${r}`);
      }, md = (t) => {
        dt(t, "Div", (e, r) => `${e}/${r}`);
...
`);
        ...
        for (let _ = 0; _ < t.length; ++_) u += t[_].dims[e], i[_] = u, c.push(t[_].dims.length), a[_] = O(`input${_}`, n, c[_]), d.push("rank"), p.push({ type: 12, data: i[_] });
  ...
  ${_.mainStart()}
    ...
    ${jh(a, m)}
        ...
        t.compute(Zh(a, o, i, r[0].dataType), { inputs: a });
      }, Sd = (t) => J({ axis: t.axis });
    });
    St = V(() => {
      "use strict";
      ...
      Qe = (t, e, r = "f32") => {
        ...
        if (e === "HardSigmoid") {
          ...
          let [r, n] = t?.activation_params || [Ps, Os];
...
`;
        ...
        let a = t[0].dims, u = t[1].dims, d = a[a.length - 2], c = u[u.length - 1], p = a[a.length - 1], m = fe(c), g = fe(p), y = fe(d), b = k.size(r) / m / y, _ = t.length > 2, S = n ? n.slice(0, -2) : r.slice(0, -2), v = [k.size(S), d, c], T = [{ type: 12, data: b }, { type: 12, data: d }, { type: 12, data: c }, { type: 12, data: p }];
        Xe(e, T), T.push(...W(S, a, u)), _ && T.push(...W(t[2].dims)), T.push(...W(v));
        let I = (E) => {
          let A = Yr("batch_dims", t[0].dataType, S.length), D = O("a", t[0].dataType, a.length, g), w = O("b", t[1].dataType, u.length, m), U = R("output", t[0].dataType, v.length, m), N = we(U.type.tensor), F = Qe(e, U.type.value, N), q = [D, w], Y = "";
          if (_) {
            let Q = o ? m : 1;
            q.push(O("bias", t[2].dataType, t[2].dims.length, Q)), Y = `${o ? `value += bias[col / ${Q}];` : `value += ${U.type.value}(bias[row + i]);`}`;
          }
          let z = [{ name: "output_size", type: "u32" }, { name: "M", type: "u32" }, { name: "N", type: "u32" }, { name: "K", type: "u32" }];
          Ye(e, z);
          let L = () => {
            let Q = `var a_data: ${D.type.value};`;
            for (let X = 0; X < g; X++) Q += `
              let b_data${X} = b[(b_offset + (k + ${X}) * uniforms.N + col) / ${m}];`;
            for (let X = 0; X < y; X++) {
              Q += `a_data = a[(a_offset + (row + ${X}) * uniforms.K + k) / ${g}];`;
              for (let Z = 0; Z < g; Z++) Q += `
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      mm_write(batch, globalRow + innerRow, globalCol, acc[innerRow]);
            ...
            `, Yh = (t) => t ? "let ACached = mm_Asub[k][tileRow + innerRow];" : "let ACached = mm_Asub[tileRow + innerRow][k];", So = (t, e, r = "f32", n, o = false, i = 32, a = false, u = 32, d = false) => {
...
`;
  ...
  ${_ ? xo(S, x, Q, L) : So(S, x, Q, L)}
        ...
        return { name: "MatMul", shaderCache: { hint: `${S};${e.activation};${_};${o}`, inputDependencies: N }, getRunData: () => ({ outputs: [{ dims: i ? i(r) : r, dataType: t[0].dataType }], dispatchGroup: { x: v[0], y: v[1], z: v[2] }, programUniforms: U }), getShaderSource: q };
      };
    });
    Pd = V(() => {
      "use strict";
      ...
      Ad();
      dn();
      eg = (t, e, r, n, o = false, i, a = 4, u = 4, d = 4, c = "f32") => {
        let p = (N) => {
          switch (N) {
            case 1:
    ...
    return ${Pe(u, c)}(0.0);`, E = Pe(d, c), A = t ? Pe(a, c) : Pe(u, c), D = t ? Pe(u, c) : Pe(a, c), w = Qe(i, E, c);
        return `
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${E}) {
      ...
      }, kd = (t, e, r, n, o, i, a, u, d) => {
        let c = e.format === "NHWC", p = c ? t[0].dims[3] : t[0].dims[1], m = r[0], g = c ? r[2] : r[3], y = c ? r[1] : r[2], b = c ? r[3] : r[1], _ = c && (p % 4 === 0 || p % 3 === 0) && b % 4 === 0, S = c ? b : g * y, x = c ? g * y : b, v = [8, 8, 1], T = n <= 8 ? [4, 1, 1] : [4, 4, 1], I = [Math.ceil(S / v[0] / T[0]), Math.ceil(x / v[1] / T[1]), Math.ceil(m / v[2] / T[2])];
        se("verbose", () => `[conv2d_mm_webgpu] dispatch = ${I}`);
        let E = _ ? c && p % 4 !== 0 ? 3 : 4 : 1, A = v[1] * T[1], D = v[0] * T[0], w = Math.max(v[0] * E, v[1]), U = n % A === 0, N = o % D === 0, F = i % w === 0, q = _ ? [E, 4, 4] : [1, 1, 1], Y = [{ type: 6, data: n }, { type: 6, data: o }, { type: 6, data: i }, { type: 6, data: [e.pads[0], e.pads[1]] }, { type: 6, data: e.strides }, { type: 6, data: e.dilations }];
        Xe(e, Y), Y.push(...W(t[0].dims, t[1].dims));
        let z = ["rank", "rank"];
        a && (Y.push(...W(t[2].dims)), z.push("rank")), Y.push(...W(r));
        let L = (Q) => {
          let X = [{ name: "dim_a_outer", type: "i32" }, { name: "dim_b_outer", type: "i32" }, { name: "dim_inner", type: "i32" }, { name: "pad", type: "i32", length: 2 }, { name: "stride", type: "i32", length: 2 }, { name: "dilation", type: "i32", length: 2 }];
          Ye(e, X);
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${_ ? `vec4<${ne}>` : ne}) {
      ...
      }`, le = O("x", t[0].dataType, t[0].dims.length, E === 3 ? 1 : E), Me = O("w", t[1].dataType, t[1].dims.length, Z), $e = [le, Me], M = R("result", t[0].dataType, r.length, Z);
          if (a) {
        ...
        ${_ ? xo(T, v, ne, void 0, !c, w) : So(T, v, ne, void 0, !c, w, false, void 0, u)}`;
        };
        return { name: "Conv2DMatMul", shaderCache: { hint: `${e.cacheKey};${E};${_};${U};${N};${F};${A};${D};${w}`, inputDependencies: z }, getRunData: () => ({ outputs: [{ dims: d ? d(r) : r, dataType: t[0].dataType }], dispatchGroup: { x: I[0], y: I[1], z: I[2] }, programUniforms: Y }), getShaderSource: L };
      };
    });
    Md = V(() => {
      "use strict";
      ...
      tg = (t) => {
        ...
        if (t === "VALID" && (t = 0), typeof t == "number") {
          ...
          let b = Dd([e, r, n, 1], [u, d, c], 1, [o, i, a], t[0]);
          m = b[0], g = b[1], y = b[2];
        } else if (t === "SAME_UPPER") {
          m = Math.ceil(e / o), g = Math.ceil(r / i), y = Math.ceil(n / a);
          let b = (m - 1) * o + u - e, _ = (g - 1) * i + d - r, S = (y - 1) * a + c - n, x = Math.floor(b / 2), v = b - x, T = Math.floor(_ / 2), I = _ - T, E = Math.floor(S / 2), A = S - E;
          p = { top: T, bottom: I, left: E, right: A, front: x, back: v };
        } else throw Error(`Unknown padding parameter: ${t}`);
        return { padInfo: p, outDepth: m, outHeight: g, outWidth: y };
      }, zd = (t, e, r, n, o, i = false, a = "channelsLast") => {
        let u, d, c, p, m;
        if (a === "channelsLast") [u, d, c, p, m] = t;
        else if (a === "channelsFirst") [u, m, d, c, p] = t;
        else throw new Error(`Unknown dataFormat ${a}`);
        let [g, , y, b, _] = e, [S, x, v] = Od(r), [T, I, E] = Od(n), A = ln(y, T), D = ln(b, I), w = ln(_, E), { padInfo: U, outDepth: N, outHeight: F, outWidth: q } = ng(o, d, c, p, S, x, v, A, D, w), Y = i ? g * m : g, z = [0, 0, 0, 0, 0];
        return a === "channelsFirst" ? z = [u, Y, N, F, q] : a === "channelsLast" && (z = [u, N, F, q, Y]), { batchSize: u, dataFormat: a, inDepth: d, inHeight: c, inWidth: p, inChannels: m, outDepth: N, outHeight: F, outWidth: q, outChannels: Y, padInfo: U, strideDepth: S, strideHeight: x, strideWidth: v, filterDepth: y, filterHeight: b, filterWidth: _, effectiveFilterDepth: A, effectiveFilterHeight: D, effectiveFilterWidth: w, dilationDepth: T, dilationHeight: I, dilationWidth: E, inShape: t, outShape: z, filterShape: e };
      }, Bd = (t, e, r, n, o, i) => {
        let a = i === "channelsLast", u = a ? t[0].dims[3] : t[0].dims[1], d = false, c = [64, 1, 1], p = { x: r.map((v, T) => T) }, m = [Math.ceil(tg(p.x.map((v) => r[v])) / c[0]), 1, 1];
        ...
        Xe(e, b), b.push(...W(t[0].dims, t[1].dims));
        ...
        let x = (v) => {
          ...
          Ye(e, T);
          let I = d ? 4 : 1, E = we(t[0].dataType), A = O("x", t[0].dataType, t[0].dims.length, g === 3 ? 1 : g), D = O("W", t[1].dataType, t[1].dims.length, I), w = [A, D], U = R("result", t[0].dataType, r.length, I), N = "";
          if (S) {
            let Y = O("bias", t[2].dataType, t[2].dims.length, I);
            w.push(Y), N += `
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${d ? `vec4<${E}>` : E} {
          return bias[${a ? j("coords", 4, 5) : j("coords", 1, 5)}${d ? "/ 4" : ""}];
        }`;
          }
          let F = Pe(g, E), q = Qe(e, F, E);
          return `
            ${N}
    ...
    Nd = V(() => {
      ...
      Rd = (t, e, r, n) => {
        ...
        Xe(e, y), y.push(...W(a, [u[0], u[1], u[2], u[3] / m]));
        let b = o ? ["rank", "rank", "rank"] : ["rank", "rank"];
        y.push(...W([r[0], r[1], r[2], r[3] / m]));
        let _ = (S) => {
          let x = R("output", t[0].dataType, r.length, m), v = we(x.type.tensor), T = Qe(e, x.type.value, v), I = O("x", t[0].dataType, a.length), E = O("w", t[1].dataType, u.length, m), A = [I, E];
          o && A.push(O("b", t[2].dataType, t[2].dims, m));
          let D = [{ name: "output_size", type: "u32" }, { name: "dilations", type: "u32", length: e.dilations.length }, { name: "strides", type: "u32", length: 2 }, { name: "pads", type: "u32", length: 2 }, { name: "output_channels_per_group", type: "u32" }];
          Ye(e, D);
          let w = d ? `
  ...
  ${S.mainStart()}
    ...
    ${x.setByOffset("global_idx", "value")}
        ...
        Xe(e, m), m.push(...W(d, c, p));
        let g = (a - 1) * e.strides[1] + c[1], y = (b) => {
          let _ = R("output", t[0].dataType, p.length, i), S = we(_.type.tensor), x = Qe(e, _.type.value, S), v = O("x", t[0].dataType, d.length, i), T = O("w", t[1].dataType, c.length, i), I = [v, T];
  ...
  ${b.mainStart()}
    ...
    Ld = V(() => {
      ...
      og = (t, e, r, n, o, i) => {
        ...
        let o = r.format === "NHWC", i = og(e[0].dims, e[1].dims, r.dilations, r.pads, r.strides, o);
        if (r.group !== 1) {
          let A = [e[0]];
          if (o) {
            let w = t.kernelCustomData.wT ?? t.compute(ze(e[1], To), { inputs: [1], outputs: [r.wIsConst ? -2 : -1] })[0];
            r.wIsConst && !t.kernelCustomData.wT && (t.kernelCustomData.wT = w), A.push(w);
          } else A.push(e[1]);
          e.length === 3 && A.push(e[2]), !t.adapterInfo.isArchitecture("ampere") && o && e[1].dims[0] === r.group && e[1].dims[1] === 1 && r.dilations[0] === 1 && r.dilations[1] === 1 ? t.compute(Ud(A, r, i, n), { inputs: A }) : t.compute(Rd(A, r, i, n), { inputs: A });
          return;
        }
        ...
        if (_ || p === 1 && m === 1 && r.dilations[0] === 1 && r.dilations[1] === 1 && r.strides[0] === 1 && r.strides[1] === 1 && r.pads[0] === 0 && r.pads[1] === 0) {
          let A = i[0], D, w, U, N = [];
          if (o) {
            let Y = t.kernelCustomData.wT ?? t.compute(ze(e[1], To), { inputs: [1], outputs: [r.wIsConst ? -2 : -1] })[0];
            if (r.wIsConst && !t.kernelCustomData.wT && (t.kernelCustomData.wT = Y), _) {
              let z = u * d * c;
              D = e[0].reshape([1, A, z]), w = Y.reshape([1, z, b]), U = [1, A, b];
            } else D = e[0].reshape([A, u * d, c]), w = Y.reshape([1, c, b]), U = [A, g * y, b];
            N.push(D), N.push(w);
          } else D = e[0].reshape([A, c, u * d]), w = e[1].reshape([1, b, c]), U = [A, b, g * y], N.push(w), N.push(D);
          a && N.push(e[2]);
          let F = U[2], q = N[0].dims[N[0].dims.length - 1];
          F < 8 && q < 8 ? t.compute(sn(N, r, i, U, o, n), { inputs: N }) : t.compute(ur(N, r, i, U, o, n), { inputs: N });
          return;
        }
        let S = true, x = t.kernelCustomData.wT ?? t.compute(ze(e[1], To), { inputs: [1], outputs: [r.wIsConst ? -2 : -1] })[0];
        r.wIsConst && !t.kernelCustomData.wT && (t.kernelCustomData.wT = x);
        let v = [e[0], x];
        a && v.push(e[2]);
        let T = o ? g * y : b, I = o ? b : g * y, E = p * m * c;
        t.compute(kd(v, r, i, T, I, E, a, S, n), { inputs: v });
      }, ag = (t, e) => {
        ...
        Vd(t, n, d, (c) => r ? [c[0], c[2], c[3]] : [c[0], c[1], c[3]]);
      }, sg = (t, e, r) => {
        let n = r.format === "NHWC" ? "channelsLast" : "channelsFirst", o = Io(r, e), i = r.autoPad === "NOTSET" ? r.pads : r.autoPad, a = zd(e[0].dims, e[1].dims, r.strides, r.dilations, i, false, n);
        t.compute(Bd(e, o, a.outShape, [a.filterDepth, a.filterHeight, a.filterWidth], [a.padInfo.front, a.padInfo.top, a.padInfo.left], n));
      }, Ao = (t, e) => {
        if (ig(t.inputs, e), t.inputs[0].dims.length === 3) ag(t, e);
        else if (t.inputs[0].dims.length === 5) sg(t, t.inputs, e);
        else {
          let r = Io(e, t.inputs);
          Vd(t, t.inputs, r);
        }
    ...
    Gd = V(() => {
      ...
      Wd = (t, e, r) => {
        ...
        let v = ["rank", "rank"], T = [e.strides[0], e.strides[1]], I = [e.kernelShape[i ? 1 : 2], e.kernelShape[i ? 2 : 3]], E = [e.dilations[0], e.dilations[1]], A = [I[0] + (e.dilations[0] <= 1 ? 0 : (e.kernelShape[i ? 1 : 2] - 1) * (e.dilations[0] - 1)), I[1] + (e.dilations[1] <= 1 ? 0 : (e.kernelShape[i ? 2 : 3] - 1) * (e.dilations[1] - 1))], D = [A[0] - 1 - Math.floor((e.pads[0] + e.pads[2]) / 2), A[1] - 1 - Math.floor((e.pads[1] + e.pads[3]) / 2)], w = [{ type: 12, data: S }, { type: 12, data: T }, { type: 12, data: I }, { type: 12, data: E }, { type: 12, data: A }, { type: 6, data: D }, { type: 12, data: g }, { type: 12, data: d }, { type: 12, data: c }, ...W(t[0].dims, t[1].dims)];
        n && (w.push(...W(t[2].dims)), v.push("rank")), w.push(...W(o));
        let U = (N) => {
          let F = [{ name: "output_size", type: "u32" }, { name: "strides", type: "u32", length: T.length }, { name: "filter_dims", type: "u32", length: I.length }, { name: "dilations", type: "u32", length: I.length }, { name: "effective_filter_dims", type: "u32", length: A.length }, { name: "pads", type: "i32", length: D.length }, { name: "input_channels_per_group_int", type: "u32" }, { name: "input_channels_per_group", type: "u32" }, { name: "output_channels_per_group", type: "u32" }], q = we(t[0].dataType), Y = i ? 1 : 2, z = i ? 2 : 3, L = i ? 3 : 1, Q = O("W", t[1].dataType, t[1].dims.length, _), X = O("Dy", t[0].dataType, t[0].dims.length, p), Z = [X, Q];
        ...
        `, p === 1) $e += `
          ...
          dotProd = dotProd + xValue * wValue;`;
            ...
            if (p === 1) {
              $e += "dotProd = dotProd";
              for (let M = 0; M < y; M++) $e += `
            + ${X.getByOffset(`x_offset + ${M}`)} * ${Q.getByOffset(`w_offset + ${M}`)}`;
              $e += ";";
            } else if (p === 2) {
    ...
    ${Me}}`;
        ...
        return { name: "ConvTranspose2D", shaderCache: { hint: `${e.cacheKey};${p}${_}${b}${m}${y}`, inputDependencies: v }, getRunData: () => ({ dispatchGroup: { x: x[0], y: x[1], z: x[2] }, outputs: [{ dims: r ? r(o) : o, dataType: t[0].dataType }], programUniforms: w }), getShaderSource: U };
      };
    });
    jd = V(() => {
      "use strict";
      ...
      St();
      pt();
      ug = (t, e, r, n, o, i) => (t - 1) * e + r + (n - 1) * o + 1 - i, dg = (t, e, r, n, o) => {
        let i = Math.floor(t / 2);
        e === "SAME_UPPER" ? (r[n] = i, r[o] = t - i) : e === "SAME_LOWER" && (r[n] = t - i, r[o] = i);
      }, lg = (t, e, r, n, o, i, a, u, d, c) => {
        ...
        for (let b = 0, _ = t.length - p - (u ? 1 : 0); b < p; ++b, ++_) {
          let S = t[_], x = m ? S * a[b] : c[b], v = ug(S, a[b], i[b], e[_], r[b], x);
          dg(v, n, i, b, b + p), m && c.push(a[b] * (S - 1) + d[b] + (e[_] - 1) * r[b] + 1 - i[b] - i[b + p]);
        }
        ...
        lg(u, r, d, t.autoPad, t.group, o, c, n, a, i);
        ...
        let o = t.kernelCustomData.wT ?? t.compute(ze(e[1], [2, 3, 0, 1]), { inputs: [1], outputs: [r.wIsConst ? -2 : -1] })[0];
        r.wIsConst && !t.kernelCustomData.wT && (t.kernelCustomData.wT = o);
        let i = [e[0], o];
        e.length === 3 && i.push(e[2]), t.compute(Wd(i, r, n), { inputs: i });
      }, pg = (t, e) => {
        let r = e.format === "NHWC", n = [t.inputs[0].reshape(r ? [t.inputs[0].dims[0], 1, t.inputs[0].dims[1], t.inputs[0].dims[2]] : [t.inputs[0].dims[0], t.inputs[0].dims[1], 1, t.inputs[0].dims[2]]), t.inputs[1].reshape([t.inputs[1].dims[0], t.inputs[1].dims[1], 1, t.inputs[1].dims[2]])];
        t.inputs.length === 3 && n.push(t.inputs[2]);
        let o = e.kernelShape;
        ...
        d = [0].concat(d);
        let c = Hd({ ...e, pads: u, strides: a, dilations: i, kernelShape: o, outputPadding: d }, n);
        qd(t, n, c, (p) => r ? [p[0], p[2], p[3]] : [p[0], p[1], p[3]]);
      }, Kd = (t, e) => {
        if (cg(t.inputs, e), t.inputs[0].dims.length === 3) pg(t, e);
        else {
          let r = Hd(e, t.inputs);
          qd(t, t.inputs, r);
        }
    ...
    Xd = V(() => {
      ...
      oe();
      mg = (t, e, r, n) => {
        let o = k.size(e), i = e.length, a = O("input", t, i), u = R("output", t, i), d = r.dataType === 6 ? r.getInt32Array()[0] : Number(r.getBigInt64Array()[0]), c = k.normalizeAxis(d, i), p = (m) => {
...
`);
        ...
        let m = t.reshape(a), g = m.dims.length, y = t.dataType, b = O("a", y, g), _ = R("output", y, g), S = (x) => `
  ...
  ${x.mainStart()}
    ...
    ${_.setByOffset("global_idx", b.getByIndices("aIndices"))}
        ...
        return { name: "DepthToSpace", shaderCache: { hint: `${t.dims};${e.blocksize};${e.mode}`, inputDependencies: ["rank"] }, getRunData: (x) => {
          let v = d ? [r, n * c, o * c, i / c ** 2] : [r, i / c ** 2, n * c, o * c], T = k.size(v), I = m.dims, E = k.sortBasedOnPerm(I, u);
          return { outputs: [{ dims: v, dataType: x[0].dataType }], dispatchGroup: { x: Math.ceil(T / 64) }, programUniforms: [{ type: 12, data: T }, ...W(I, E)] };
        }, getShaderSource: S };
      }, Yd = (t, e) => {
        fg(t.inputs), t.compute(gg(t.inputs[0], e));
      }, Jd = (t) => J({ blocksize: t.blocksize, mode: t.mode, format: t.format });
    });
    ul = V(() => {
      "use strict";
      ee();
      ...
      Ce();
      oe();
      Tt = 256, cn = 512, Eo = 2 * Math.PI, rl = (t) => {
        let e = [], r = t;
...
`;
        ...
        let n = "", o = 1, i = 0;
        for (let a of t) n += bg(a, o, e, i, r), o *= a, i = cn - i;
      ...
      }, nl = (t, e) => [e, t.length, t.inputComponents, t.outputComponents, t.inverse, t.onesided].join(";"), ol = (t) => [{ type: 12, data: t.batch }, { type: 12, data: t.signalLength }, { type: 12, data: t.inner }, { type: 12, data: t.outputLength }], il = (t, e, r) => t.registerUniform("batch", "u32").registerUniform("signalLength", "u32").registerUniform("inner", "u32").registerUniform("outputLength", "u32").declareVariables(e, r), wg = (t) => {
        let { dataType: e, length: r, inputComponents: n, outputComponents: o, inverse: i, onesided: a } = t, u = Ae(e), d = i ? 1 : -1, c = i ? 1 / r : 1, p = rl(r), m = (g) => {
          let y = O("x", e, [1]), b = R("y", e, [1]), _ = (E) => {
            let A = `inBase + (${E}) * uniforms.inner * ${n}u`, D = `f32(${y.getByOffset(A)})`, w = n === 2 ? `f32(${y.getByOffset(`${A} + 1u`)})` : "0.0";
            return `vec2<f32>(${D}, ${w})`;
          }, S;
          if (i && a) {
            let E = Math.floor(r / 2) + 1, A = r % 2 === 0 ? `select(provided, provided - 1u, provided == ${E}u)` : "provided";
            S = `
    ...
    workgroupBarrier();`;
          let { code: x, resultOffset: v } = yg(p, r, d), T = c === 1 ? `smem[${v}u + i]` : `smem[${v}u + i] * ${Rt(c)}`, I = o === 2 ? b.setByOffset("off + 1u", `${u}(v.y)`) : "";
          return `
  ${il(g, y, b)}
...
${x}    for (var i = local_idx; i < uniforms.outputLength; i += ${Tt}u) {
      ...
      ${I}
        ...
        return { name: "DFT", shaderCache: { hint: nl(t, "fft"), inputDependencies: ["type"] }, getShaderSource: m, getRunData: () => ({ outputs: [{ dims: t.outputDims, dataType: e }], programUniforms: ol(t), dispatchGroup: { x: t.batch } }) };
      }, $g = (t) => {
        let { dataType: e, length: r, inputComponents: n, outputComponents: o, inverse: i, onesided: a } = t, u = Ae(e), d = i ? 1 : -1, c = i ? 1 / r : 1, p = (m) => {
          let g = O("x", e, [1]), y = R("y", e, [1]), b = (T) => {
            let I = `inBase + (${T}) * uniforms.inner * ${n}u`, E = `f32(${g.getByOffset(I)})`, A = n === 2 ? `f32(${g.getByOffset(`${I} + 1u`)})` : "0.0";
            return `vec2<f32>(${E}, ${A})`;
    ...
    return vec2<f32>(0.0, 0.0);
      ...
      knMod += k;
      if (knMod >= ${r}u) { knMod -= ${r}u; }`, x = o === 2 ? y.setByOffset("off + 1u", `${u}(v.y)`) : "", v = c === 1 ? "acc" : `acc * ${Rt(c)}`;
          return `
  ${il(m, g, y)}
  fn cmul(a: vec2<f32>, b: vec2<f32>) -> vec2<f32> {
    return vec2<f32>(a.x * b.x - a.y * b.y, a.x * b.y + a.y * b.x);
  ...
  ${m.mainStart(Tt)}
    ...
    for (var k = local_idx; k < uniforms.outputLength; k += ${Tt}u) {
      ...
      ${x}
        ...
        return { name: "DFT", shaderCache: { hint: nl(t, "direct"), inputDependencies: ["type"] }, getShaderSource: p, getRunData: () => ({ outputs: [{ dims: t.outputDims, dataType: e }], programUniforms: ol(t), dispatchGroup: { x: t.batch } }) };
      }, tl = (t) => {
        ...
        vg(t.inputs);
        let r = t.inputs[0], n = r.dims.length, o = e.inverse !== 0, i = e.onesided !== 0, a = tl(t.inputs[1]);
        if (a !== void 0 && a <= 0) throw new Error("dft_length must be greater than zero.");
        let u = k.normalizeAxis(tl(t.inputs[2]) ?? e.axis, n);
        ...
        let p = d.length <= cn && rl(d.length) !== void 0 ? wg(d) : $g(d);
        t.compute(p, { inputs: [0] });
      }, sl = (t) => J({ axis: t.axis ?? 1, inverse: t.inverse ?? 0, onesided: t.onesided ?? 0 });
    });
    ml = V(() => {
      "use strict";
      ee();
      ...
      Ce();
      oe();
      ko = "[a-zA-Z]|\\.\\.\\.", pn = "(" + ko + ")+", dl = "^" + pn + "$", xg = "(" + pn + ",)*" + pn, Sg = "^" + xg + "$", Po = class {
        constructor(e = -1) {
        ...
        constructor(e, r) {
          ...
          if (n.split(",").forEach((u, d) => {
            ...
            if (!u.match(RegExp(dl))) throw new Error("Invalid LHS term");
        ...
        processTerm(e, r, n, o = -1) {
          ...
          if (!e.match(RegExp(dl)) && !r && e !== "") throw new Error("Invalid LHS term");
      ...
      }, ll = (t) => t + "_max", Tg = (t, e, r, n) => {
        let i = t.map((p) => p.length).map((p, m) => O(`input${m}`, e, p)), a = k.size(n), u = R("output", e, n.length), d = [...r.symbolToInfo.keys()].filter((p) => !r.rhs.symbolToIndices.has(p)), c = (p) => {
          let m = [], g = "var prod = 1.0;", y = "var sum = 0.0;", b = "sum += prod;", _ = [], S = [], x = [], v = [], T = r.symbolToInfo.size === r.rhs.symbolToIndices.size;
          r.symbolToInfo.forEach((E, A) => {
            if (r.rhs.symbolToIndices.has(A)) {
              let D = r.rhs.symbolToIndices.get(A)?.[0];
              D !== void 0 && r.lhs.forEach((w, U) => {
                if (E.inputIndices.includes(U)) {
                  let N = w.symbolToIndices.get(A);
                  if (N === void 0) throw new Error("Invalid symbol error");
                  N.forEach((F) => {
                    m.push(`${i[U].indicesSet(`input${U}Indices`, F, u.indicesGet("outputIndices", D))}`);
                  });
                }
              });
            } else r.lhs.forEach((D, w) => {
              if (E.inputIndices.includes(w)) {
                let U = D.symbolToIndices.get(A);
                if (U === void 0) throw new Error("Invalid symbol error");
                U.forEach((N) => {
                  _.push(`${i[w].indicesSet(`input${w}Indices`, N, `${A}`)}`);
                }), v.push(`prod *= ${i[w].getByIndices(`input${w}Indices`)};`);
              }
            }), S.push(`for(var ${A}: u32 = 0; ${A} < uniforms.${ll(A)}; ${A}++) {`), x.push("}");
          });
          let I = T ? [...m, `let sum = ${i.map((E, A) => E.getByIndices(`input${A}Indices`)).join(" * ")};`] : [...m, y, ...S, ..._, g, ...v, b, ...x];
          return `
...
`)};
        ...
        let r = new Oo(t.inputs, e.equation), n = r.outputDims, o = t.inputs.map((i, a) => i.dims);
        t.compute(Tg(o, t.inputs[0].dataType, r, n));
      }, pl = (t) => {
    ...
    gl = V(() => {
      ...
      Ig = (t) => {
        ...
        return n;
      }, Cg = (t, e) => t.length > e.length ? fl(t, e) : fl(e, t), Ag = (t) => {
        let e = t[0].dims, r = Array.from(t[1].getBigInt64Array(), Number), n = Cg(e, r), o = t[0].dataType, i = o === 9 || k.size(e) === 1, a = o === 9 || e.length > 0 && e[e.length - 1] % 4 === 0 ? 4 : 1, u = i || n.length > 0 && n[n.length - 1] % 4 === 0 ? 4 : 1, d = Math.ceil(k.size(n) / u), c = (m) => {
          let g = O("input", o, e.length, a), y = R("output", o, n.length, u), b;
          if (o === 9) {
            let _ = (S, x, v = "") => `
    ...
    ${b}`;
        ...
        Ig(t.inputs), t.compute(Ag(t.inputs), { inputs: [0] });
      };
    });
    yl = V(() => {
      "use strict";
      ...
      Eg = (t) => {
        let e = t[0].dataType, r = k.size(t[0].dims), n = k.size(t[1].dims), o = n % 4 === 0, i = (a) => {
          let u = O("x", e, [1], 4), d = O("bias", e, [1], 4), c = R("y", e, [1], 4), p = [{ name: "output_vec_size", type: "u32" }, { name: "bias_size", type: "u32" }], m = (y) => `
    ...
    ${a.mainStart(Bt)}
      ...
      ${c.setByOffset("global_idx", vo("x_in"))}
        ...
        return { name: "FastGeluWithBias", shaderCache: { hint: `${o}`, inputDependencies: ["type", "type"] }, getShaderSource: i, getRunData: (a) => ({ outputs: [{ dims: a[0].dims, dataType: a[0].dataType }], programUniforms: [{ type: 12, data: Math.ceil(r / 4) }, { type: 12, data: n }], dispatchGroup: { x: Math.ceil(r / Bt / 4) } }) };
      }, bl = (t) => {
        t.inputs.length < 2 || k.size(t.inputs[1].dims) === 0 ? id(t) : t.compute(Eg(t.inputs));
      };
    });
    $l = V(() => {
      "use strict";
      ...
      kg = (t) => {
        ...
        let u = r[i], d = t[0].dataType === 9 ? 4 : 1, c = Math.ceil(k.size(a) / d), p = [{ type: 12, data: c }, { type: 6, data: u }, { type: 12, data: i }, ...W(t[0].dims, t[1].dims, a)], m = (g) => {
          let y = O("data", t[0].dataType, t[0].dims.length, d), b = O("inputIndices", t[1].dataType, t[1].dims.length), _ = R("output", t[0].dataType, a.length, d), S = (v) => {
            let T = n.length, I = `var indicesIndices${v}  = ${b.type.indices}(0);`;
            for (let E = 0; E < T; E++) I += `${T > 1 ? `indicesIndices${v}[${E}]` : `indicesIndices${v}`} = ${a.length > 1 ? `outputIndices${v}[uniforms.axis + ${E}]` : `outputIndices${v}`};`;
            I += `
        ...
        `;
            for (let E = 0, A = 0; E < o; E++) E === i ? (I += `${o > 1 ? `dataIndices${v}[${E}]` : `dataIndices${v}`} = u32(idx${v});`, A += T) : (I += `${o > 1 ? `dataIndices${v}[${E}]` : `dataIndices${v}`} = ${a.length > 1 ? `outputIndices${v}[${A}]` : `outputIndices${v}`};`, A++);
            return I;
          }, x;
          if (t[0].dataType === 9) {
            let v = (T, I, E = "") => `
      ...
      }, _l = (t) => J({ axis: t.axis }), wl = (t, e) => {
        let r = t.inputs;
        kg(r), t.compute(Pg(t.inputs, e));
      };
    });
    Sl = V(() => {
      "use strict";
  ...
  ${g.mainStart()}
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
        ...
        let b = Og(t, r[1], g, e.batchDims, n, u, m, p, a), _ = e.batchDims + a;
        if (_ > n.length) throw new Error("last dimension of indices must not be larger than rank of input tensor");
        let S = i.slice(0, -1).concat(n.slice(_)), x = k.size(S), v = [{ type: 12, data: x }, { type: 12, data: d }, ...W(r[0].dims, b.dims, S)], T = (I) => {
          let E = O("data", r[0].dataType, r[0].dims.length), A = O("slice_offsets", 12, b.dims.length), D = R("output", r[0].dataType, S.length);
          return `
        ...
        t.compute({ name: "GatherND", shaderCache: { hint: e.cacheKey, inputDependencies: ["rank", "rank"] }, getRunData: () => ({ outputs: [{ dims: S, dataType: o }], dispatchGroup: { x: Math.ceil(x / 64) }, programUniforms: v }), getShaderSource: T }, { inputs: [r[0], b] });
      }, xl = (t) => ({ batchDims: t.batch_dims, cacheKey: "" });
    });
    Cl = V(() => {
      "use strict";
      ee();
      ...
      Dg = (t, e) => {
        ...
        let d = k.size(u), c = t[2].dataType, m = t[0].dataType === 22, g = [{ type: 12, data: d }, { type: 12, data: a }, { type: 12, data: i }, { type: 12, data: e.blockSize }, ...W(...t.map((b, _) => b.dims), u)], y = (b) => {
          let _ = O("data", t[0].dataType, t[0].dims.length), S = O("inputIndices", t[1].dataType, t[1].dims.length), x = O("scales", t[2].dataType, t[2].dims.length), v = t.length > 3 ? O("zeroPoint", t[3].dataType, t[3].dims.length) : void 0, T = R("output", c, u.length), I = [_, S, x];
          v && I.push(v);
        ...
        let r = t.inputs;
        Dg(r, e), t.compute(zg(t.inputs, e));
      }, Il = (t) => J({ blockSize: t.blockSize, gatherAxis: t.gatherAxis, quantizeAxis: t.quantizeAxis });
    });
    kl = V(() => {
      "use strict";
      ee();
      ...
      Bg = (t) => {
        ...
        let r = t[0].dims, n = t[0].dataType, o = r.length, i = t[1].dims, a = t[1].dataType, u = k.normalizeAxis(e.axis, o), d = r[u], c = i.slice(0), p = k.size(c), m = O("input", n, o), g = O("indicesInput", a, i.length), y = R("output", n, c.length), b = [{ type: 12, data: p }, { type: 6, data: d }, { type: 12, data: u }];
      ...
      }, Al = (t) => J({ axis: t.axis }), El = (t, e) => {
        let r = t.inputs;
        Bg(r), t.compute(Mg(t.inputs, e));
      };
    });
    Dl = V(() => {
      "use strict";
      ...
      Rg = (t) => {
        ...
        let _ = (x) => {
          let v = "";
          e.transA && e.transB ? v = "value += a[k * uniforms.M + m] * b[n * uniforms.K + k];" : e.transA && !e.transB ? v = "value += a[k * uniforms.M + m] * b[k * uniforms.N + n];" : !e.transA && e.transB ? v = "value += a[m * uniforms.K + k] * b[n * uniforms.K + k];" : !e.transA && !e.transB && (v = "value += a[m * uniforms.K + k] * b[k * uniforms.N + n];");
          let T = e.alpha === 1 ? "" : "value *= uniforms.alpha;", I = O("a", t[0].dataType, t[0].dims), E = O("b", t[1].dataType, t[1].dims), A = I.type.value, D = null, w = [I, E];
          t.length === 3 && (D = O("c", t[2].dataType, t[2].dims.length), w.push(D));
  ...
  ${x.mainStart()}
    ...
    output[global_idx] = value;
          ...
          let v = O("a", t[0].dataType, t[0].dims), T = O("b", t[1].dataType, t[1].dims), I = null, E = [v, T];
          t.length === 3 && (I = O("c", t[2].dataType, t[2].dims.length), E.push(I));
          let A = R("output", t[0].dataType, u.length);
          E.push(A);
          let D = [{ name: "num_tile_n", type: "u32" }, { name: "M", type: "u32" }, { name: "N", type: "u32" }, { name: "K", type: "u32" }, { name: "alpha", type: "f32" }, { name: "beta", type: "f32" }], w = "", U = "";
          e.transA && e.transB ? (U = `
  ...
  ${x.mainStart([d, d, 1])}
    ...
    if (m < uniforms.M && n < uniforms.N) {
      output[m * uniforms.N + n] = value;
        ...
        Rg(t.inputs), t.compute(Ug(t.inputs, e));
      };
    });
    Ml = V(() => {
      "use strict";
...
`, Fg = (t, e, r) => (() => {
      ...
      })() + `${t.setByOffset("global_idx", "result")}`, qg = (t, e) => {
  ...
  ${m.mainStart()}
    ${m.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${Fg(a, u, e)}
        ...
        Ng(t.inputs), t.compute(qg(t.inputs, e));
      }, Bl = (t) => J({ alignCorners: t.align_corners, mode: t.mode, paddingMode: t.padding_mode, format: t.format });
    });
    Do = V(() => {
      "use strict";
      ee();
      ...
      oe();
      pt();
      Ue = (t, e) => t.length > e && t[e].dims.length > 0 ? t[e] : void 0, Zg = (t, e) => {
        ...
        if (a && k.size(a.dims) > 0) {
          T = 8;
          let D = a.dims;
          throw D.length === 1 ? D[0] === p ? T = 1 : D[0] === 3 * p + 2 && (T = 3) : D.length === 2 && D[0] === p && D[1] === v && (T = 5), T === 8 ? new Error('Input "key_padding_mask" shape shall be (batch_size) or (batch_size, total_sequence_length)') : new Error("Mask not supported");
        }
        let I = false, E = g;
        ...
        if (u && k.size(u.dims) > 0) {
          ...
          if (u.dims[0] !== p || u.dims[1] !== e.numHeads || u.dims[2] !== m || u.dims[3] !== v) throw new Error('Expect "attention_bias" shape (batch_size, num_heads, sequence_length, total_sequence_length)');
        }
      ...
      }, Ul = (t) => J({ ...t }), Rl = J({ perm: [0, 2, 1, 3] }), Qg = (t, e, r, n, o, i, a) => {
        let u = [n, o, i], d = k.size(u), c = [{ type: 12, data: d }, { type: 12, data: a }, { type: 12, data: i }], p = (m) => {
          let g = R("qkv_with_bias", e.dataType, u), y = O("qkv", e.dataType, u), b = O("bias", r.dataType, u), _ = [{ name: "output_size", type: "u32" }, { name: "bias_offset", type: "u32" }, { name: "hidden_size", type: "u32" }];
          return `
  ...
  ${m.mainStart()}
    ...
    qkv_with_bias[global_idx] = qkv[global_idx] + bias[bias_offset_idx];
        ...
        if (a && k.size(a.dims) > 0) {
          ...
          return d = Qg(t, i, a, e, n, r * o, u), d = d.reshape([e, n, r, o]), r === 1 || n === 1 ? d : t.compute(ze(d, Rl.perm), { inputs: [d], outputs: [-1] })[0];
        } else return i.dims.length === 3 && (d = i.reshape([e, n, r, o])), r === 1 || n === 1 ? d : t.compute(ze(d, Rl.perm), { inputs: [d], outputs: [-1] })[0];
      }, Nl = (t, e) => {
        let r = Zg(t.inputs, e), n = t.inputs[0], o = Ue(t.inputs, 1), i = Ue(t.inputs, 2), a = Ue(t.inputs, 3), u = Ue(t.inputs, 4), d = Ue(t.inputs, 5), c = Ue(t.inputs, 6), p = Ue(t.inputs, 7);
...
`)}
        ...
        let r = t[0].dims, n = k.size(r), o = t[0].dataType, i = k.normalizeAxis(e.axis, r.length), a = new Array(e.numOutputs), u = O("input", o, r.length), d = new Array(e.numOutputs), c = [], p = [], m = 0, g = [{ type: 12, data: n }];
  ...
  ${b.mainStart()}
    ...
    writeBufferData(output_number, indices, global_idx);
        ...
        Xg(t.inputs);
        let r = t.inputs.length === 1 ? e : Yg(t.inputs, e);
        t.compute(zo(t.inputs, r), { inputs: [0] });
      }, Ll = (t) => {
    ...
    Mo = V(() => {
      ...
      tb = (t, e) => {
        ...
        let { interleaved: r, numHeads: n, rotaryEmbeddingDim: o, scale: i } = e, a = t[0].dims[0], u = k.sizeFromDimension(t[0].dims, 1), d = t[0].dims[t[0].dims.length - 2], c = u / d, p = t[2].dims[1], m = o === 0 ? p * 2 : c / n, g = new Array(a, d, c / m, m - p), y = k.computeStrides(g), b = [{ type: 1, data: i }, { type: 12, data: g }, { type: 12, data: y }, ...t[0].dims.length === 3 ? new Array({ type: 12, data: [u, c, m, 1] }) : [], ...t[0].dims.length === 4 ? new Array({ type: 12, data: [u, m, d * m, 1] }) : [], ...W(t[0].dims, t[1].dims, t[2].dims, t[3].dims, t[0].dims)], _ = (S) => {
          let x = O("input", t[0].dataType, t[0].dims.length), v = O("position_ids", t[1].dataType, t[1].dims.length), T = O("cos_cache", t[2].dataType, t[2].dims.length), I = O("sin_cache", t[3].dataType, t[3].dims.length), E = R("output", t[0].dataType, t[0].dims.length);
        ...
        return { name: "RotaryEmbedding", shaderCache: { hint: J({ interleaved: r }).cacheKey, inputDependencies: ["rank", "rank", "rank", "rank"] }, getShaderSource: _, getRunData: () => ({ outputs: [{ dims: t[0].dims, dataType: t[0].dataType }], dispatchGroup: { x: Math.ceil(k.size(g) / Bt) }, programUniforms: b }) };
      }, Wl = (t, e) => {
        tb(t.inputs, e), t.compute(mn(t.inputs, e));
      };
    });
    Fl = V(() => {
      "use strict";
      ...
      rb = (t, e) => {
        ...
        let T = 0, I = false, E = e.kvNumHeads ? b * e.kvNumHeads : p;
        ...
        return { batchSize: d, sequenceLength: c, pastSequenceLength: g, kvSequenceLength: m, totalSequenceLength: -1, maxSequenceLength: -1, inputHiddenSize: 0, hiddenSize: p, vHiddenSize: E, headSize: b, vHeadSize: Math.floor(E / e.kvNumHeads), numHeads: e.numHeads, kvNumHeads: e.kvNumHeads, nReps: e.numHeads / e.kvNumHeads, pastPresentShareBuffer: false, maskType: T, scale: e.scale, broadcastResPosBias: false, passPastInKv: I, qkvFormat: v };
      }, nb = J({ perm: [0, 2, 1, 3] }), Gl = (t, e, r) => {
        let n = e, o = r.kvNumHeads;
        return e.dims.length === 3 && r.kvSequenceLength !== 0 && (n = e.reshape([r.batchSize, r.kvSequenceLength, o, r.headSize]), n = t.compute(ze(n, nb.perm), { inputs: [n], outputs: [-1] })[0]), n;
      }, ob = (t, e, r, n) => {
        let o = 7, i = ["type", "type"], a = [t * e], u = t * e, d = [{ type: 12, data: u }, { type: 12, data: e }, { type: 12, data: t }], c = (p) => {
          let m = O("seq_lens", r.dataType, r.dims), g = O("total_seq_lens", n.dataType, n.dims), y = R("pos_ids", o, a), b = [{ name: "output_size", type: "u32" }, { name: "sequence_length", type: "u32" }, { name: "batch_size", type: "u32" }];
          return `
  ...
  `;
        ...
        let n = t.inputs[0], o = t.inputs[1] && t.inputs[1].dims.length > 0 ? t.inputs[1] : void 0, i = t.inputs[2] && t.inputs[2].dims.length > 0 ? t.inputs[2] : void 0, a = t.inputs[3] && t.inputs[3].dims.length !== 0 ? t.inputs[3] : void 0, u = t.inputs[4] && t.inputs[4].dims.length !== 0 ? t.inputs[4] : void 0, d = t.inputs.length > 4 ? t.inputs[5] : void 0, c = t.inputs.length > 5 ? t.inputs[6] : void 0, p = r.kvNumHeads ? r.kvNumHeads : r.numHeads, m = J({ axis: 2, numOutputs: 3, splitSizes: [r.numHeads * r.headSize, p * r.headSize, p * r.headSize] }), [g, y, b] = !o && !i ? t.compute(zo([n], m), { inputs: [n], outputs: [-1, -1, -1] }) : [n, o, i], _, S;
        if (e.doRotary) {
          let I = t.compute(ob(r.batchSize, r.sequenceLength, d, c), { inputs: [d, c], outputs: [-1] })[0], E = t.inputs[7], A = t.inputs[8], D = J({ interleaved: e.rotaryInterleaved !== 0, numHeads: r.numHeads, rotaryEmbeddingDim: 0, scale: e.scale }), w = [g, I, E, A], U = [-1];
          _ = t.compute(mn(w, D), { inputs: w, outputs: U })[0], w.splice(0, 1, y);
        ...
        let x = dr(t, r.batchSize, r.numHeads, r.sequenceLength, r.headSize, e.doRotary ? _ : g, void 0, 0), v = Gl(t, e.doRotary ? S : y, r), T = Gl(t, b, r);
        Ft(t, x, v, T, void 0, void 0, a, u, void 0, r, d, c);
      };
    });
    jl = V(() => {
      "use strict";
      ...
      ql = (t, e, r, n, o, i, a, u) => {
        ...
        S.push(...W(y, b));
        let x = (v) => {
          let T = O("x", e.dataType, 3, d), I = O("scale", r.dataType, r.dims), E = O("bias", n.dataType, n.dims), A = R("output", 1, 3, 2), D = [T, I, E, A];
          return `
  ...
  ${v.mainStart(g)}
    ...
    if (local_idx == 0) {
      ...
      output[workgroup_index] = vec2f(channel_scale, channel_shift);
        ...
        let n = e[0].dims, o = n, i = 2, a = n[0], u = n[1], d = k.sizeFromDimension(n, i), c = fe(d), p = k.size(o) / c, m = ql(t, e[0], e[1], e[2], a, d, u, r.epsilon), g = [a, u, d / c], y = [a, u], b = ["type", "none"], _ = (S) => {
          let x = O("x", e[0].dataType, g.length, c), v = O("scale_shift", 1, y.length, 2), T = R("output", e[0].dataType, g.length, c), I = [x, v, T];
          return `
  ...
  ${S.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${T.setByOffset("global_idx", "value")};
        ...
        g = g && n[n.length - 1] !== 1;
        let b = g ? t.compute(ze(t.inputs[0], y), { inputs: [t.inputs[0]], outputs: [-1] })[0] : t.inputs[0].reshape(Array.from({ length: n.length }, (x, v) => n[y[v]])), _ = ql(t, b, e[1], e[2], i, u, a, r.epsilon), S = (x) => {
          let v = we(e[0].dataType), T = d === 1 ? "vec2f" : `mat${d}x2f`, I = (D) => {
            let w = D === 0 ? "x" : "y", U = d === 1 ? "f32" : `vec${d}f`;
            switch (d) {
              case 1:
                return `${v}(${U}(scale.${w}))`;
              case 2:
                return `vec2<${v}>(${U}(scale[0].${w}, scale[1].${w}))`;
              case 4:
                return `vec4<${v}>(${U}(scale[0].${w}, scale[1].${w}, scale[2].${w}, scale[3].${w}))`;
              default:
  ...
  ${x.mainStart()}
    ...
    output[global_idx] = fma(input[global_idx], ${I(0)}, ${I(1)});
        ...
        e.format === "NHWC" ? ab(t, t.inputs, e) : ib(t, t.inputs, e);
      };
    });
    Ql = V(() => {
      "use strict";
      ...
      sb = (t) => {
       ...
       Got scale size of ${m} and bias size of ${g}`);
        ...
        a && _.push("type");
        let x = r > 1, v = r > 2, T = (E) => {
          let A = we(t[0].dataType), D = [O("x", t[0].dataType, t[0].dims, b), O("scale", i.dataType, i.dims, b)];
          a && D.push(O("bias", a.dataType, a.dims, b)), D.push(R("output", t[0].dataType, u, b)), x && D.push(R("mean_data_output", 1, y)), v && D.push(R("inv_std_output", 1, y));
  ...
  ${E.mainStart()}
    ...
    ${v ? "inv_std_output[global_idx] = inv_std_dev" : ""};
        ...
        return x && I.push({ dims: y, dataType: 1 }), v && I.push({ dims: y, dataType: 1 }), { name: "LayerNormalization", shaderCache: { hint: `${b};${r};${n}`, inputDependencies: _ }, getRunData: () => ({ outputs: I, dispatchGroup: { x: Math.ceil(c / 64) }, programUniforms: S }), getShaderSource: T };
      }, Zl = (t, e) => {
        sb(t.inputs), t.compute(ub(t.inputs, e, t.outputCount));
      };
    });
    Yl = V(() => {
      "use strict";
    ...
    tc = V(() => {
      ...
      lb = (t, e) => {
        ...
        let r = t[0].dims, n = r.length, o = r[n - 2], i = e.k, a = e.n, u = r.slice(0, n - 2), d = k.size(u), p = t[1].dims[2] / 4, m = t[0].dataType, g = fe(e.k), y = fe(p), b = fe(a), _ = u.concat([o, a]), S = o > 1 && a / b % 2 === 0 ? 2 : 1, x = k.size(_) / b / S, v = 64, T = [], I = [d, o, i / g], E = k.convertShape(t[1].dims).slice();
        E.splice(-1, 1, p / y), T.push(...W(I)), T.push(...W(E)), T.push(...W(t[2].dims)), t.length === 4 && T.push(...W(k.convertShape(t[3].dims)));
        let A = [d, o, a / b];
        T.push(...W(A));
        let D = (w) => {
          let U = I.length, N = O("a", t[0].dataType, U, g), F = O("b", 12, E.length, y), q = O("scales", t[2].dataType, t[2].dims.length), Y = [N, F, q], z = t.length === 4 ? O("zero_points", 12, t[3].dims.length) : void 0;
          z && Y.push(z);
          let L = A.length, Q = R("output", t[0].dataType, L, b), X = we(t[0].dataType), Z = (() => {
            switch (g) {
              case 1:
                return `array<${X}, 8>`;
              case 2:
          ...
          })(), ne = Math.floor(32 / e.bits), ie = Math.floor(ne / 8), le = () => {
            let M = "";
            for (let G = 0; G < ie; G++) {
        ...
        return { name: "MatMulNBits", shaderCache: { hint: `${e.blockSize};${e.bits};${g};${y};${b};${S};${v}`, inputDependencies: Array(t.length).fill("rank") }, getRunData: () => ({ outputs: [{ dims: _, dataType: m }], dispatchGroup: { x }, programUniforms: T }), getShaderSource: D };
      }, pb = (t, e) => {
        let r = t[0].dims, n = r.length, o = r[n - 2], i = e.k, a = e.n, u = r.slice(0, n - 2), d = k.size(u), p = t[1].dims[2] / 4, m = t[0].dataType, g = fe(e.k), y = fe(p), b = u.concat([o, a]), _ = 128, S = a % 8 === 0 ? 8 : a % 4 === 0 ? 4 : 1, x = _ / S, v = Math.floor(32 / e.bits), T = x * y * v, I = T / g, E = T / e.blockSize, A = k.size(b) / S, D = [], w = [d, o, i / g], U = k.convertShape(t[1].dims).slice();
        U.splice(-1, 1, p / y), D.push(...W(w)), D.push(...W(U)), D.push(...W(t[2].dims)), t.length === 4 && D.push(...W(k.convertShape(t[3].dims)));
        let N = [d, o, a];
        D.push(...W(N));
        let F = (q) => {
          let Y = w.length, z = O("a", t[0].dataType, Y, g), L = O("b", 12, U.length, y), Q = O("scales", t[2].dataType, t[2].dims.length), X = [z, L, Q], Z = t.length === 4 ? O("zero_points", 12, t[3].dims.length) : void 0;
          Z && X.push(Z);
          let ne = N.length, ie = R("output", t[0].dataType, ne), le = we(t[0].dataType), Me = () => {
            switch (g) {
              case 1:
                return `
        ...
        return { name: "BlockwiseMatMulNBits32", shaderCache: { hint: `${e.blockSize};${g};${y};${x};${S}`, inputDependencies: Array(t.length).fill("rank") }, getRunData: () => ({ outputs: [{ dims: b, dataType: m }], dispatchGroup: { x: A }, programUniforms: D }), getShaderSource: F };
      }, Jl = (t, e) => {
        lb(t.inputs, e), e.blockSize === 32 && t.adapterInfo.isVendor("intel") && t.adapterInfo.isArchitecture("gen-12lp") ? t.compute(pb(t.inputs, e)) : t.compute(cb(t.inputs, e));
      }, ec = (t) => J(t);
    });
    nc = V(() => {
      "use strict";
      ...
      `;
        ...
        switch (r.mode) {
          case 0:
            return fb(t, e, r.pads.length);
          case 1:
            return hb(t, e, r.pads.length);
          case 2:
            return gb(t, e, r.pads.length);
          case 3:
        ...
        let u = ["rank"], d = (c) => {
          let p = R("output", t[0].dataType, r.length), m = O("x", t[0].dataType, n.length), g = m.type.value, y = yb(p, n.length, e), b = [{ name: "output_size", type: "u32" }, { name: "pads", type: "i32", length: e.pads.length }];
        ...
        mb(t.inputs);
        let r = wb(t.inputs, e);
        t.compute(_b(t.inputs, r), { inputs: [0] });
      };
    });
    wc = V(() => {
      "use strict";
      ...
      fn = (t) => {
        ...
        zt.adjustPoolAttributes(r, o, a, u, d, c);
        let p = zt.computePoolOutputShape(r, o, u, d, a, c, e.autoPad, e.ceilMode), m = Object.assign({}, e);
      ...
      }, sc = (t) => `${t.format};${t.ceilMode};${t.autoPad};${t.kernelShape.length}`, $b = (t) => `${sc(t)};${t.countIncludePad}`, vb = (t) => `${sc(t)};${t.storageOrder};${t.dilations}`, uc = (t) => ({ format: t.format, autoPad: ["NOTSET", "VALID", "SAME_UPPER", "SAME_LOWER"][t.auto_pad], ceilMode: t.ceil_mode, kernelShape: t.kernel_shape, strides: t.strides, pads: t.pads }), dc = (t, e, r, n) => {
        let [o, i] = oc(e, n, r), a = O("x", e.dataType, e.dims.length), u = a.type.value, d = "value += x_val;", c = "";
        o.countIncludePad ? c += `value /= ${u}(uniforms.kernelSize);` : c += `value /= ${u}(i32(uniforms.kernelSize) - pad);`;
        let [p, m, g, y, b] = ic(i, o);
        p.push(...W(e.dims, i));
        let _ = ["rank"];
        return { name: t, shaderCache: { hint: `${n.cacheKey};${g};${y};${b}`, inputDependencies: _ }, getRunData: () => ({ outputs: [{ dims: i, dataType: e.dataType }], dispatchGroup: { x: Math.ceil(k.size(i) / 64) }, programUniforms: p }), getShaderSource: (S) => ac(S, a, e.dims.length, i.length, o, d, c, 0, m, g, y, b) };
      }, lc = (t) => {
        let e = t.count_include_pad !== 0, r = uc(t);
        ...
        return { ...n, cacheKey: $b(n) };
      }, cc = (t, e) => {
        fn(t.inputs), t.compute(dc("AveragePool", t.inputs[0], false, e));
      }, pc = { autoPad: "", ceilMode: 0, countIncludePad: false, kernelShape: [], strides: [], pads: [], storageOrder: 0, dilations: [] }, mc = (t) => {
        let e = t.format;
        return { format: e, ...pc, cacheKey: e };
      }, fc = (t, e) => {
        fn(t.inputs), t.compute(dc("GlobalAveragePool", t.inputs[0], true, e));
      }, hc = (t, e, r, n) => {
        let [o, i] = oc(e, n, r), a = `
      value = max(x_val, value);
    `, u = "", d = O("x", e.dataType, e.dims.length), c = ["rank"], [p, m, g, y, b] = ic(i, o);
        return p.push(...W(e.dims, i)), { name: t, shaderCache: { hint: `${n.cacheKey};${g};${y};${b}`, inputDependencies: c }, getRunData: () => ({ outputs: [{ dims: i, dataType: e.dataType }], dispatchGroup: { x: Math.ceil(k.size(i) / 64) }, programUniforms: p }), getShaderSource: (_) => ac(_, d, e.dims.length, i.length, o, a, u, e.dataType === 10 ? -65504 : -1e5, m, g, y, b) };
      }, gc = (t, e) => {
        fn(t.inputs), t.compute(hc("MaxPool", t.inputs[0], false, e));
      }, bc = (t) => {
        let e = t.storage_order, r = t.dilations, n = uc(t);
        ...
        return { ...o, cacheKey: vb(o) };
      }, yc = (t) => {
        let e = t.format;
        return { format: e, ...pc, cacheKey: e };
      }, _c = (t, e) => {
        fn(t.inputs), t.compute(hc("GlobalMaxPool", t.inputs[0], true, e));
      };
    });
    xc = V(() => {
      "use strict";
      ...
      ${A.setByOffset("global_idx", `${A.type.value}(x_value - zero_point_value) * scale_value`)};
        ...
        return { name: "DequantizeLinear", shaderCache: { hint: e.cacheKey, inputDependencies: E ? ["rank", "rank", "rank"] : ["rank", "rank"] }, getShaderSource: N, getRunData: () => ({ outputs: [{ dims: i, dataType: a }], dispatchGroup: { x: Math.ceil(u / x / 64), y: 1, z: 1 }, programUniforms: U }) };
      }, $c = (t, e) => {
        Sb(t.inputs, e), t.compute(Tb(t.inputs, e));
      }, vc = (t) => J({ axis: t.axis, blockSize: t.blockSize });
    });
    Tc = V(() => {
      "use strict";
      Le();
    ...
    Ac = V(() => {
      ...
      Ab = (t, e, r, n) => {
        ...
        let r = t[0].dims, n = t[1].dims, o = r, i = 1, a = Math.ceil(k.sizeToDimension(n, n.length - 1) / i), u = n[n.length - 1], d = k.sizeFromDimension(r, u), c = [{ type: 12, data: a }, { type: 12, data: u }, { type: 12, data: d }, ...W(t[1].dims, t[2].dims, o)], p = (m) => {
          let g = O("indices", t[1].dataType, t[1].dims.length), y = O("updates", t[2].dataType, t[2].dims.length, i), b = e.reduction !== "none" && e.reduction !== "" ? Fs("output", t[0].dataType, o.length) : R("output", t[0].dataType, o.length, i);
          return `
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${Ab(e.reduction, "output[data_offset + i]", "value", b.type.value)}
      ...
      }, Ic = (t) => J({ reduction: t.reduction }), Cc = (t, e) => {
        t.compute(Eb(t.inputs, e), { inputs: [t.inputs[1], t.inputs[2]], outputs: [] });
      };
    });
    Dc = V(() => {
      "use strict";
      ...
      kb = (t, e) => {
        ...
        if (u > 0 && t.length > u && t[u].dims.length === 1 && t[u].dims[0] > 0) {
          ...
          kb(n, e), e.axes.length > 0 && Pb(n, e.axes, c).forEach((p, m) => n[m] = p);
        }
...
`, Db = (t, e) => `fn getOriginalCoordinateFromResizedCoordinate(xResized: u32, xScale: f32, lengthResized: u32,
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${e} { ` + (() => {
      ...
      })() + "}", zb = (t, e, r) => `fn getNearestPixelFromOriginal(xOriginal: ${r}, isDownSample: bool) -> ${r} {` + (() => {
        switch (t) {
  ...
  fn bicubicInterpolation(output_indices: ${e.type.indices}) -> ${b} {
    ...
    depth = max(0, min(depth, ${r[u]} - 1));
      ...
      return (x111 * dx2 * dy2 * dz2 + x112 * dx2 * dy2 * dz1 + x121 * dx2 * dy1 *dz2 + x122 * dx2 * dy1 * dz1 +
        ...
        let a = t.dims, u = Bb(i, e.axes, a.length), d = Mb(a, n, o, e.axes), c = n.slice();
        n.length === 0 && (c = a.map((v, T) => v === 0 ? 1 : d[T] / v), e.keepAspectRatioPolicy !== "stretch" && (d = Rb(a, c, e)));
        let p = R("output", t.dataType, d.length), m = O("input", t.dataType, a.length), g = k.size(d), y = a.length === d.length && a.every((v, T) => v === d[T]), b = e.coordinateTransformMode === "tf_crop_and_resize", _ = e.extrapolationValue, S = m.type.value, x = (v) => `
      ${y ? "" : `
      ...
      ${(() => {
          switch (e.mode) {
            ...
            case "linear":
              ...
              ${(() => {
                if (a.length === 2 || a.length === 4) return `${Lb(m, p, a, b, _)}`;
                if (a.length === 3 || a.length === 5) return `${Gb(m, p, a, b, _)}`;
            ...
            case "cubic":
              return `
            ${(() => {
                if (a.length === 2 || a.length === 4) return `${Wb(m, p, a, d, c, u, e.cubicCoeffA, b, e.extrapolationValue, e.excludeOutside)}`;
...
`}
        ...
        Ob(t.inputs, e, i, r, n, o), t.compute(Hb(t.inputs[0], e, i, r, n, o), { inputs: [0] });
      }, Oc = (t) => {
    ...
    Bc = V(() => {
      ...
      qb = (t) => {
        ...
        let o = e.simplified, i = t[0].dims, a = k.size(i), u = i, d = a, c = i.slice(-1)[0], p = n ? i.slice(0, -1).concat(1) : [], m = !o && t.length > 3, g = t.length > 4, y = n && r > 1, b = n && r > 2, _ = r > 3, S = 64, x = fe(c), v = [{ type: 12, data: d }, { type: 12, data: x }, { type: 12, data: c }, { type: 1, data: e.epsilon }], T = (E) => {
          let A = [{ name: "output_size", type: "u32" }, { name: "components", type: "u32" }, { name: "hidden_size", type: "u32" }, { name: "epsilon", type: "f32" }], D = [O("x", t[0].dataType, t[0].dims, x), O("skip", t[1].dataType, t[1].dims, x), O("gamma", t[2].dataType, t[2].dims, x)];
          m && D.push(O("beta", t[3].dataType, t[3].dims, x)), g && D.push(O("bias", t[4].dataType, t[4].dims, x)), D.push(R("output", t[0].dataType, u, x)), y && D.push(R("mean_output", 1, p)), b && D.push(R("inv_std_output", 1, p)), _ && D.push(R("input_skip_bias_sum", t[0].dataType, u, x));
      ...
      ${E.mainStart([S, 1, 1])}
        ...
        return r > 1 && I.push({ dims: p, dataType: 1 }), r > 2 && I.push({ dims: p, dataType: 1 }), r > 3 && I.push({ dims: i, dataType: t[0].dataType }), { name: "SkipLayerNormalization", shaderCache: { hint: `${x};${y};${b};${_}`, inputDependencies: t.map((E, A) => "type") }, getShaderSource: T, getRunData: () => ({ outputs: I, dispatchGroup: { x: Math.ceil(d / c) }, programUniforms: v }) };
      }, zc = (t, e) => {
        qb(t.inputs);
        let n = [0];
        t.outputCount > 1 && n.push(-3), t.outputCount > 2 && n.push(-3), t.outputCount > 3 && n.push(3), t.compute(Kb(t.inputs, e, t.outputCount, false), { outputs: n });
      };
    });
    Nc = V(() => {
      "use strict";
      ...
      jb = (t, e) => {
      ...
      }, Qb = (t, e, r) => `fn calculateInputIndices(output_indices: ${e.type.indices}) -> ${t.type.indices} {
          var input_indices: ${t.type.indices};
          var carry = 0u;
        ...
        let a = e.starts.map((x, v) => Mc(x, v, r, o, i)), u = e.ends.map((x, v) => Mc(x, v, r, o, i));
        ...
        i.forEach((x, v, T) => {
          if (x < 0) {
            let I = (u[v] - a[v]) / x, E = a[v], A = E + I * i[v];
            a[v] = A, u[v] = E, T[v] = -x;
          }
        });
        let c = r.slice(0);
        ...
        let p = { dims: c, dataType: t[0].dataType }, m = R("output", t[0].dataType, c.length), g = O("input", t[0].dataType, t[0].dims.length), y = k.size(c), b = [{ name: "outputSize", type: "u32" }, { name: "starts", type: "u32", length: a.length }, { name: "signs", type: "i32", length: d.length }, { name: "steps", type: "u32", length: i.length }], _ = [{ type: 12, data: y }, { type: 12, data: a }, { type: 6, data: d }, { type: 12, data: i }, ...W(t[0].dims, c)], S = (x) => `
      ${x.registerUniforms(b).declareVariables(g, m)}
        ...
        jb(t.inputs, e);
        let r = Zb(t.inputs, e);
        t.compute(Xb(t.inputs, r), { inputs: [0] });
      }, Uc = (t) => {
    ...
    Wc = V(() => {
      ...
      Yb = (t) => {
        ...
        u ? (c = Array.from({ length: i }, (D, w) => w), c[a] = i - 1, c[i - 1] = a, d = t.compute(ze(r, c), { inputs: [r], outputs: [-1] })[0]) : d = r;
        let p = d.dims, m = p[i - 1], g = o / m, y = fe(m), b = m / y, _ = 64;
        g === 1 && (_ = 256);
        let S = (D, w) => w === 4 ? `max(max(${D}.x, ${D}.y), max(${D}.z, ${D}.w))` : w === 2 ? `max(${D}.x, ${D}.y)` : w === 3 ? `max(max(${D}.x, ${D}.y), ${D}.z)` : D, x = O("x", d.dataType, d.dims, y), v = R("result", d.dataType, d.dims, y), T = x.type.value, I = we(d.dataType) === "f32" ? `var threadMax = ${T}(-3.4028234663852886e+38f);` : `var threadMax = ${T}(-65504.0h);`, E = (D) => `
    ...
    Fc = V(() => {
      ...
      te();
      oe();
      Gc = (t) => Array.from(t.getBigInt64Array(), Number), ey = (t) => {
        ...
        if (Gc(t[1]).length !== t[0].dims.length) throw new Error("Tile `repeats` input should have same number of elements as rank of input data tensor");
      }, ty = (t, e) => {
        let r = [];
        for (let n = 0; n < t.length; ++n) r.push(t[n] * e[n]);
        return r;
      }, ry = (t, e) => {
        let r = t[0].dims, n = e ?? Gc(t[1]), o = ty(r, n), i = k.size(o), a = t[0].dataType, u = O("input", a, r.length), d = R("output", a, o.length), c = (p) => `
      ...
      ${d.setByOffset("global_idx", u.getByIndices("input_indices"))}
        ...
        ey(t.inputs), t.compute(ry(t.inputs), { inputs: [0] });
      };
    });
    Kc = V(() => {
      "use strict";
      ...
      oe();
      ny = (t, e, r, n, o) => {
        let i = R("output_data", o, r.length, 4), a = O("a_data", e[1].dataType, e[1].dims.length, 4), u = O("b_data", e[2].dataType, e[2].dims.length, 4), d = O("c_data", e[0].dataType, e[0].dims.length, 4), c, p = (m, g, y) => `select(${g}, ${m}, ${y})`;
        ...
        let d = Math.ceil(u / 4);
        return { name: "Where", shaderCache: { inputDependencies: ["rank", "rank", "rank"] }, getShaderSource: (c) => ny(c, t, a, i, o), getRunData: () => ({ outputs: [{ dims: a, dataType: o }], dispatchGroup: { x: Math.ceil(u / 64 / 4) }, programUniforms: [{ type: 12, data: d }, ...W(n, e, r, a)] }) };
      }, qc = (t) => {
        t.compute(oy(t.inputs));
      };
    });
    Zc = V(() => {
      "use strict";
    ...
    Qc = V(() => {
      ...
      gn = class {
        ...
        build(e, r) {
          ...
          let a = qs(r, this.backend.device.limits), u = e.getShaderSource(a), d = `${o.join(`
`)}
...
${u}`, c = n.createShaderModule({ code: d, label: e.name });
    ...
    Yc = V(() => {
      ...
      iy = (t, e) => {
        ...
        let n = t.name;
        return t.shaderCache?.hint && (n += "[" + t.shaderCache.hint + "]"), n += ":" + r + `:${iy(e, t.shaderCache?.inputDependencies ?? new Array(e.length).fill("dims"))}`, n;
      }, Ro = class {
        constructor(e) {
        ...
        async initialize(e, r) {
          ...
          this.adapterInfo = new Ro(u), this.gpuDataManager = Gs(this), this.programManager = new gn(this), this.kernels = /* @__PURE__ */ new Map(), this.kernelPersistentData = /* @__PURE__ */ new Map(), this.kernelCustomData = /* @__PURE__ */ new Map(), Gr(e.logLevel, !!e.debug), this.device.onuncapturederror = (d) => {
          ...
          this.queryType !== "none" && (this.commandEncoder.resolveQuerySet(this.querySet, 0, this.pendingDispatchNumber * 2, this.queryResolveBuffer, 0), e = this.device.createBuffer({ size: this.pendingDispatchNumber * 2 * 8, usage: GPUBufferUsage.MAP_READ | GPUBufferUsage.COPY_DST }), this.pendingQueries.set(e, this.pendingKernels), this.pendingKernels = [], this.commandEncoder.copyBufferToBuffer(this.queryResolveBuffer, 0, e, 0, this.pendingDispatchNumber * 2 * 8)), this.device.queue.submit([this.commandEncoder.finish()]), this.gpuDataManager.refreshPendingBuffers(), this.commandEncoder = null, this.pendingDispatchNumber = 0, this.queryType !== "none" && e.mapAsync(GPUMapMode.READ).then(() => {
            ...
            for (let o = 0; o < r.length / 2; o++) {
              ...
              if (this.env.webgpu.profiling?.ondata) this.env.webgpu.profiling.ondata({ version: 1, inputsMetadata: m.map((x) => ({ dims: x.dims, dataType: rt(x.dataType) })), outputsMetadata: g.map((x) => ({ dims: x.dims, dataType: rt(x.dataType) })), kernelId: a, kernelType: d, kernelName: c, programName: p, startTime: _, endTime: S });
                ...
                let v = "";
                g.forEach((T, I) => {
                  v += `output[${I}]: [${T.dims}] | ${rt(T.dataType)}, `;
                }), console.log(`[profiling] kernel "${a}|${d}|${c}|${p}" ${x}${v}start time: ${_} ns, execution time: ${S - _} ns`);
              }
              Cr("GPU", `${p}::${y}::${b}`);
            }
        ...
        run(e, r, n, o, i, a) {
          ...
          for (let T = 0; T < d.length; ++T) {
            ...
            if (I && this.temporaryData.push(D), E) {
              let w = this.kernelPersistentData.get(this.currentKernelId);
              w || (w = [], this.kernelPersistentData.set(this.currentKernelId, w)), w.push(D);
            }
            y.push(D);
          }
          ...
          if (p) {
            ...
            p.forEach((w) => {
              ...
              let Y = w.type === 10 ? 8 : 4;
              T += U.length > 4 ? Math.ceil(U.length / Y) * F : U.length * N;
            });
            let E = 16;
            T = Math.ceil(T / E) * E;
            ...
            p.forEach((w, U) => {
              ...
              if (w.type === 6) new Int32Array(A, N, F.length).set(F);
              else if (w.type === 12) new Uint32Array(A, N, F.length).set(F);
              else if (w.type === 10) new Uint16Array(A, N, F.length).set(F);
              else if (w.type === 1) new Float32Array(A, N, F.length).set(F);
              else throw new Error(`Unsupported uniform type: ${rt(w.type)}`);
            });
            let D = this.gpuDataManager.create(T, GPUBufferUsage.COPY_DST | GPUBufferUsage.UNIFORM);
            this.device.queue.writeBuffer(D.buffer, 0, A, 0, T), this.gpuDataManager.release(D.id), b = { offset: 0, size: T, buffer: D.buffer };
          }
          let _ = this.programManager.normalizeDispatchGroupSize(c), S = _[1] === 1 && _[2] === 1, x = ay(e, r, S), v = this.programManager.getArtifact(x);
          if (v || (v = this.programManager.build(e, _), this.programManager.setArtifact(x, v), se("info", () => `[artifact] key: ${x}, programName: ${e.name}`)), p && v.uniformVariablesInfo) {
            ...
            for (let T = 0; T < p.length; T++) {
              let I = p[T], E = I.type, A = typeof I.data == "number" ? 1 : I.data.length, [D, w] = v.uniformVariablesInfo[T];
              if (E !== D || A !== w) throw new Error(`Uniform variable ${T} mismatch: expect type ${D} with size ${w}, got type ${E} with size ${A} in program "${v.programInfo.name}".`);
            }
          }
          if (se("info", () => `[ProgramManager] run "${e.name}" (key=${x}) with ${_[0]}x${_[1]}x${_[2]}`), this.queryType !== "none" || this.sessionStatus === "capturing") {
            let T = { kernelId: this.currentKernelId, programName: v.programInfo.name, inputTensorViews: r, outputTensorViews: g };
            this.pendingKernels.push(T), this.sessionStatus === "capturing" && this.capturedPendingKernels.get(this.currentSessionId).push(T);
          }
          return this.programManager.run(v, u, y, _, b), Re(e.name), g;
        }
        upload(e, r) {
    ...
    ep = V(() => {
      ...
      lr = class t {
        ...
        if (t === "webgpu") {
          let i = (Yc(), er(Xc)).WebGpuBackend, a = new i();
    ...
    Jn = V(() => {
      ...
      uy = (t, e) => {
        ...
        uy(t.wasm.numThreads, or(t.logLevel));
      }, Dr = async (t, e) => {
        ye().asyncInit?.();
        ...
        try {
          if ([a, d] = await Cs(e), e?.externalData && o.mountExternalData) {
            let I = [];
            for (let E of e.externalData) {
              let A = typeof E == "string" ? E : E.path, D = typeof E == "string" ? E : E.data;
              I.push(ir(D).then((w) => {
                o.mountExternalData(A, w);
              }));
            }
            await Promise.all(I);
          }
          for (let I of e?.executionProviders ?? []) if ((typeof I == "string" ? I : I.name) === "webnn") {
            if (o.shouldTransferToMLTensor = false, typeof I != "string") {
              let A = I, D = A?.context, w = A?.gpuDevice, U = A?.deviceType, N = A?.powerPreference;
              D ? o.currentContext = D : w ? o.currentContext = await o.webnnCreateMLContext(w) : o.currentContext = await o.webnnCreateMLContext({ deviceType: U, powerPreference: N });
          ...
          let [m, g] = dy(i), y = !!e?.enableGraphCapture, b = [], _ = [], S = [], x = [], v = [];
          for (let I = 0; I < m; I++) {
            let [E, A, D] = tp(i, I);
            E === 0 && me("Can't get an input name."), c.push(E);
            let w = o.UTF8ToString(E);
            b.push(w), S.push(A === 0 ? { name: w, isTensor: false } : { name: w, isTensor: true, type: rt(A), shape: D });
          }
          for (let I = 0; I < g; I++) {
            let [E, A, D] = tp(i, I + m);
            E === 0 && me("Can't get an output name."), p.push(E);
            let w = o.UTF8ToString(E);
            _.push(w), x.push(A === 0 ? { name: w, isTensor: false } : { name: w, isTensor: true, type: rt(A), shape: D });
            {
          ...
          let T = null;
          return v.some((I) => I === "gpu-buffer" || I === "ml-tensor" || I === "ml-tensor-cpu-output") && (u = o._OrtCreateBinding(i), u === 0 && me("Can't create IO binding."), T = { handle: u, outputPreferredLocations: v, outputPreferredLocationsEncoded: v.map((I) => I === "ml-tensor-cpu-output" ? "ml-tensor" : I).map((I) => oo(I)) }), Ut.set(i, [i, c, p, T, y, false]), [i, b, _, S, x];
        } catch (m) {
        ...
        if (m === "gpu-buffer") {
          ...
          if (Array.isArray(x)) {
            ...
            for (let v = 0; v < x.length; v++) {
              if (typeof x[v] != "string") throw new TypeError(`tensor data at index ${v} is not a string`);
              u.setValue(y + v * d, Ge(x[v], r), "*");
            }
          } else {
            let v = u.webnnIsGraphInput, T = u.webnnIsGraphOutput;
            if (c !== "string" && v && T) {
              let I = u.UTF8ToString(o);
              if (v(n, I) || T(n, I)) {
                let E = vt(c);
                b = xt(E, p), g = "ml-tensor";
                let A = u.webnnCreateTemporaryTensor, D = u.webnnUploadTensor;
                if (!A || !D) throw new Error('Tensor location "ml-tensor" is not supported without using WebNN.');
                let w = await A(n, E, p);
                D(w, new Uint8Array(x.buffer, x.byteOffset, x.byteLength)), y = w;
        ...
        try {
          p.forEach((v, T) => u.setValue(S + T * d, v, d === 4 ? "i32" : "i64"));
          let x = u._OrtCreateTensor(vt(c), y, b, S, p.length, oo(g));
        ...
        let c = d[0], p = d[1], m = d[2], g = d[3], y = d[4], b = d[5], _ = e.length, S = n.length, x = 0, v = [], T = [], I = [], E = [], A = [], D = a.stackSave(), w = a.stackAlloc(_ * u), U = a.stackAlloc(_ * u), N = a.stackAlloc(S * u), F = a.stackAlloc(S * u);
        try {
          [x, v] = Ts(i), _t("wasm prepareInputOutputTensor");
          for (let L = 0; L < _; L++) await rp(r[L], T, E, t, p[e[L]], e[L], y);
          for (let L = 0; L < S; L++) await rp(o[L], I, E, t, m[n[L]], _ + n[L], y);
          ...
          if (g && !b) {
            let { handle: L, outputPreferredLocations: Q, outputPreferredLocationsEncoded: X } = g;
            ...
            for (let Z = 0; Z < S; Z++) {
              let ne = n[Z];
              o[Z]?.[3] ? (A.push(I[Z]), a._OrtBindOutput(L, m[ne], I[Z], 0) !== 0 && me(`Can't bind pre-allocated output[${Z}] for session=${t}.`)) : a._OrtBindOutput(L, m[ne], 0, X[ne]) !== 0 && me(`Can't bind output[${Z}] to ${Q[Z]} for session=${t}.`);
            }
          ...
          for (let L = 0; L < S; L++) {
            ...
            if (Q === I[L] || A.includes(I[L])) {
              Y.push(o[L]), Q !== I[L] && a._OrtReleaseTensor(Q) !== 0 && me("Can't release tensor.");
              continue;
            }
            let X = a.stackSave(), Z = a.stackAlloc(4 * u), ne = false, ie, le = 0;
            try {
              a._OrtGetTensorData(Q, Z, Z + u, Z + 2 * u, Z + 3 * u) !== 0 && me(`Can't access output tensor data on index ${L}.`);
              let $e = u === 4 ? "i32" : "i64", M = Number(a.getValue(Z, $e));
              le = a.getValue(Z + u, "*");
              let G = a.getValue(Z + u * 2, "*"), be = Number(a.getValue(Z + u * 3, $e)), ke = [];
              for (let ge = 0; ge < be; ge++) ke.push(Number(a.getValue(G + ge * u, $e)));
              a._OrtFree(G) !== 0 && me("Can't free memory for tensor dims.");
              let ve = ke.reduce((ge, Te) => ge * Te, 1);
              ie = rt(M);
              let Oe = g?.outputPreferredLocations[n[L]];
              if (ie === "string") {
                if (Oe === "gpu-buffer" || Oe === "ml-tensor") throw new Error("String tensor is not supported on GPU.");
                let ge = [];
                for (let Te = 0; Te < ve; Te++) {
                  let qe = a.getValue(le + Te * u, "*"), Ne = a.getValue(le + (Te + 1) * u, "*"), Se = Te === ve - 1 ? void 0 : Ne - qe;
                  ge.push(a.UTF8ToString(qe, Se));
                }
                Y.push([ie, ke, ge, "cpu"]);
              } else if (Oe === "gpu-buffer" && ve > 0) {
                let ge = a.jsepGetBuffer;
                if (!ge) throw new Error('preferredLocation "gpu-buffer" is not supported without using WebGPU.');
                let Te = ge(le), qe = xt(M, ve);
                if (qe === void 0 || !Lr(ie)) throw new Error(`Unsupported data type: ${ie}`);
                ne = true, Y.push([ie, ke, { gpuBuffer: Te, download: a.jsepCreateDownloader(Te, qe, ie), dispose: () => {
                  a._OrtReleaseTensor(Q) !== 0 && me("Can't release tensor.");
                } }, "gpu-buffer"]);
              } else if (Oe === "ml-tensor" && ve > 0) {
                ...
                if (xt(M, ve) === void 0 || !Wr(ie)) throw new Error(`Unsupported data type: ${ie}`);
                if (!Te(t, ie, false)) throw new Error(`preferredLocation "ml-tensor" for ${ie} output is not supported by current WebNN Context.`);
                let Ne = await ge(t, le, M, ke, false);
                ne = true, Y.push([ie, ke, { mlTensor: Ne, download: a.webnnCreateMLTensorDownloader(le, ie), dispose: () => {
                  a.webnnReleaseTensorId(le), a._OrtReleaseTensor(Q);
                } }, "ml-tensor"]);
              } else if (Oe === "ml-tensor-cpu-output" && ve > 0) {
                let ge = a.webnnCreateMLTensorDownloader(le, ie)(), Te = Y.length;
                ne = true, z.push((async () => {
                  let qe = [Te, await ge];
                  return a.webnnReleaseTensorId(le), a._OrtReleaseTensor(Q), qe;
                })()), Y.push([ie, ke, [], "cpu"]);
              } else {
                let ge = Ht(ie), Te = new ge(ve);
                new Uint8Array(Te.buffer, Te.byteOffset, Te.byteLength).set(a.HEAPU8.subarray(le, le + Te.byteLength)), Y.push([ie, ke, Te, "cpu"]);
              }
            } finally {
              a.stackRestore(X), ie === "string" && le && a._free(le), ne || a._OrtReleaseTensor(Q);
            }
          }
          g && !y && (a._OrtClearBoundOutputs(g.handle) !== 0 && me("Can't clear bound outputs."), Ut.set(t, [c, p, m, g, y, false]));
          for (let [L, Q] of await Promise.all(z)) Y[L][2] = Q;
          return wt("wasm ProcessOutputTensor"), Y;
        } finally {
          a.webnnOnRunEnd?.(c), a.stackRestore(D), T.forEach((q) => a._OrtReleaseTensor(q)), I.forEach((q) => a._OrtReleaseTensor(q)), E.forEach((q) => a._free(q)), x !== 0 && a._OrtReleaseRunOptions(x), v.forEach((q) => a._free(q));
        }
      }, Rr = (t) => {
        let e = ye(), r = Ut.get(t);
      ...
      Nt = () => !!_e.wasm.proxy && typeof document < "u", cr = false, yn = false, _n = false, Lo = /* @__PURE__ */ new Map(), jt = (t, e) => {
        ...
        if (!yn) {
          ...
          if (cr = true, Nt()) return new Promise((t, e) => {
            Fe?.terminate(), vs().then(([r, n]) => {
              try {
                Fe = n, Fe.onerror = (i) => e(i), Fe.onmessage = cy, Vo = [t, e];
                let o = { type: "init-wasm", in: _e };
                !o.in.wasm.wasmPaths && (r || to) && (o.in.wasm.wasmPaths = { wasm: new URL("ort-wasm-simd-threaded.jsep.wasm", import.meta.url).href }), Fe.postMessage(o), bn = r;
              } catch (o) {
                e(o);
              }
            }, e);
          ...
          try {
            await Pr(_e.wasm), await Or(_e), yn = true;
          } catch (t) {
            throw _n = true, t;
          } finally {
            cr = false;
        ...
        await Dr(_e, t);
      }, ip = async (t) => Nt() ? (Zt(), new Promise((e, r) => {
        jt("copy-from", [e, r]);
    ...
    cp = V(() => {
      ...
      lp = (t, e) => {
        ...
        async fetchModelAndCopyToWasmMemory(e) {
          return ip(await ir(e));
        }
        async loadModel(e, r) {
          Ve();
          let n;
          typeof e == "string" ? n = await this.fetchModelAndCopyToWasmMemory(e) : n = e, [this.sessionId, this.inputNames, this.outputNames, this.inputMetadata, this.outputMetadata] = await ap(n, r), Re();
        }
        async dispose() {
          return sp(this.sessionId);
        }
        async run(e, r, n) {
          Ve();
          let o = [], i = [];
          ...
          let d = o.map((g, y) => lp(g, () => `input "${this.inputNames[i[y]]}"`)), c = a.map((g, y) => g ? lp(g, () => `output "${this.outputNames[u[y]]}"`) : null), p = await up(this.sessionId, i, d, u, c, n), m = {};
          for (let g = 0; g < p.length; g++) m[this.outputNames[u[g]]] = a[g] ?? py(p[g]);
          return Re(), m;
        }
        startProfiling() {
        }
    ...
    mp = {};
    Wt(mp, { OnnxruntimeWebAssemblyBackend: () => $n, initializeFlags: () => pp, wasmBackend: () => my });
    fp = V(() => {
      "use strict";
      Le();
      Wo();
    ...
    PT = Yn;
    {
      let t = (fp(), er(mp)).wasmBackend;
      Pt("webgpu", t, 5), Pt("webnn", t, 5), Pt("cpu", t, 10), Pt("wasm", t, 10);
    }
    Object.defineProperty(_e.versions, "web", { value: ds, enumerable: true });
  }
});
...
// src/fe/voice/audioPlayer.ts
var SCHEDULE_MARGIN_S = 0.02;
...
var AudioChunkPlayer = class {
  ...
  async scheduleChunk(b64, sampleRate = 24e3, channels = 1) {
    ...
    if (isRiff || isId3 || isOgg) {
      try {
        buf = await this.ctx.decodeAudioData(bytes.buffer.slice(bytes.byteOffset, bytes.byteOffset + bytes.byteLength));
      } catch (e) {
    ...
    src.onended = () => {
      ...
      if (this.sources.length === 0) {
        this.playing = false;
        this.endedHandlers.forEach((fn2) => fn2());
      }
    };
  ...
  decodeRawPcm(bytes, sampleRate, channels) {
    ...
    for (let ch2 = 0; ch2 < channels; ch2++) {
      const channelData = buf.getChannelData(ch2);
  ...
  duck(targetGain = 0.15, fadeMs = 35) {
    ...
    this.gain.gain.exponentialRampToValueAtTime(Math.max(0.01, targetGain), now + fadeMs / 1e3);
  }
  unduck(fadeMs = 60) {
    if (!this.playing) return;
    const now = this.ctx.currentTime;
    this.gain.gain.cancelScheduledValues(now);
    this.gain.gain.setValueAtTime(Math.max(0.01, this.gain.gain.value), now);
    this.gain.gain.exponentialRampToValueAtTime(1, now + fadeMs / 1e3);
  }
  stop() {
    const now = this.ctx.currentTime;
    this.gain.gain.cancelScheduledValues(now);
    this.gain.gain.setValueAtTime(Math.max(1e-3, this.gain.gain.value), now);
    this.gain.gain.linearRampToValueAtTime(1e-4, now + 0.035);
    setTimeout(() => {
  ...
  onEnd(fn2) {
    this.endedHandlers.push(fn2);
    return () => {
      this.endedHandlers = this.endedHandlers.filter((h) => h !== fn2);
    };
  }
};

// src/fe/voice/pcmWorklet.ts
var PCM16K_PROCESSOR = `
...
function pcmWorkletSource() {
  return PCM16K_PROCESSOR;
}
var loadedWorklets = /* @__PURE__ */ new WeakSet();
...
async function startPcmCapture(opts) {
  ...
  return {
    stop() {
      ...
      try {
        opts.sourceNode.disconnect(node);
      } catch {
      }
    }
  };
...
var WsAsrClient = class {
  constructor(opts = {}) {
    ...
    this.stopTimeoutMs = opts.stopTimeoutMs ?? 5e3;
  }
  on(event, fn2) {
...
// src/fe/voice/session.ts
var ID_KEY = "guig_session_id";
var TOKEN_KEY = "guig_session_token";
var ONE_YEAR = 365 * 24 * 60 * 60;
var MINT_URL = "https://api.guig.dev/v1/memory/session";
...
function writeCookie(name, value) {
  ...
  document.cookie = `${name}=${encodeURIComponent(value)}; path=/; max-age=${ONE_YEAR}; SameSite=Lax` + domain + (secure ? "; Secure" : "");
}
...
function cached() {
  const id2 = readCookie(ID_KEY) || readLocal(ID_KEY);
  const token = readCookie(TOKEN_KEY) || readLocal(TOKEN_KEY);
  return id2 && token ? { session_id: id2, session_token: token } : null;
}
var inflight = null;
function ensureSession() {
  ...
  inflight = fetch(MINT_URL, { method: "POST" }).then((r) => r.ok ? r.json() : null).then((j2) => {
    if (!j2?.session_id || !j2?.session_token) return null;
    const s = { session_id: j2.session_id, session_token: j2.session_token };
    persist(s);
    return s;
  }).catch(() => null).finally(() => {
    inflight = null;
...
// src/fe/voice/ser-browser.ts
var LABELS = ["Pleased", "Relaxed", "Neutral", "Sad", "Tension"];
var HINTS = {
...
var MODEL_URL = "/models/ser/model_fp16.onnx";
var MIN_SAMPLES = 800;
var MAX_SAMPLES = 48e4;
var SerBrowser = class {
  constructor() {
    this.session = null;
    this.ort = null;
  ...
  async preload() {
    ...
    try {
      ...
      this.activeBackend = providers.includes("webgpu") && this.session?.executionProviders?.[0] === "webgpu" ? "webgpu" : "wasm";
    } catch {
      this.session = await this.ort.InferenceSession.create(MODEL_URL, {
        executionProviders: ["wasm"],
        graphOptimizationLevel: "all"
...
function softmaxTop1(logits) {
  ...
  for (let j2 = 0; j2 < logits.length; j2++) if (logits[j2] > mx) {
    mx = logits[j2];
    mi = j2;
  }
  let sum = 0;
  const probs = new Float32Array(logits.length);
  for (let j2 = 0; j2 < logits.length; j2++) {
    probs[j2] = Math.exp(logits[j2] - mx);
    sum += probs[j2];
  }
  return { label: LABELS[mi], score: probs[mi] / sum };
}
var ser = new SerBrowser();
...
// src/fe/voice/fallbackTts.ts
init_dist();
var FallbackTts = class {
  static {
   ...
   */
  static speakWithWebSpeech(text, options) {
    return new Promise((resolve, reject) => {
      try {
        ...
        const frenchVoice = voices.find(
          (v) => v.name.includes("Google") && v.lang.startsWith("fr") || v.lang === "fr-CA" || v.lang === "fr-FR" || v.lang.startsWith("fr")
        );
        if (frenchVoice) {
  ...
  static stop() {
    ...
    if (Capacitor.isNativePlatform()) {
      Promise.resolve().then(() => (init_esm(), esm_exports)).then(({ TextToSpeech: TextToSpeech2 }) => {
        TextToSpeech2.stop().catch(() => {
        });
      }).catch(() => {
      });
    }
  }
  static isCurrentlySpeaking() {
...
var UltraBlablaLiveApp = class _UltraBlablaLiveApp {
  ...
  initWebAudioApi() {
    try {
      ...
      console.log("[Web Next-Gen] Web Audio API pr\xEAte.");
    } catch (err) {
  ...
  async initWebGPU() {
    if ("gpu" in navigator) {
      try {
        ...
        console.log("[Web Next-Gen] WebGPU initialis\xE9 avec succ\xE8s ! Pr\xEAt pour le Neural Canvas 2028.");
      } catch (err) {
  ...
  setupListeners() {
    ...
    this.clearBtn?.addEventListener("click", () => {
      this.clearMessages();
      this.addMessage("SYSTEM", "Historique nettoy\xE9. Pr\xEAt \xE0 discuter.", "system");
  ...
  scheduleAutoRestart(delayMs = 260) {
  ...
  setupVoiceClientListeners() {
    ...
    this.wsVoice.on("token", (msg) => {
      ...
      this.streamHoloSubtitle(responseText, 3e3);
    });
  ...
  async startListening() {
    ...
    try {
      ...
      this.showError(`Microphone indisponible: ${err?.message || "Acc\xE8s refus\xE9"}`);
      this.updateUI("idle");
    }
  }
  ...
  streamHoloSubtitle(text, durationEstimateMs = 3e3) {
    ...
    }, Math.max(2e3, durationEstimateMs));
  }
  updateUI(newState) {
    this.state = newState;
  ...
  playChime(freq, duration) {
    try {
      ...
      gain.gain.exponentialRampToValueAtTime(1e-4, this.audioCtx.currentTime + duration);
      osc.connect(gain);
